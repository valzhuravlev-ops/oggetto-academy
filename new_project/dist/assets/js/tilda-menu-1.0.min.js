...
function t_menu__findAnchorLinks(t, e) {
  var n = document.getElementById("rec" + t);
  if (n && t_menu__isBlockVisible(n)) {
    var r = e + '[href*="#"]:not(.tooltipstered)',
      i = n ? n.querySelectorAll(r) : [];
    i.length && t_menu__updateActiveLinks(i, e);
  }
}
function t_menu__updateActiveLinks(t, e) {
  var n = e.slice(2);
  ((n = ".t" + (n = parseInt(n, 10))), (t = Array.prototype.slice.call(t)));
  var r = null,
    i = [],
    o = {};
  ((t = t.reverse()).forEach(function (t) {
    var e = t_menu__getSectionByHref(t);
    e && e.id && (i.push(e), (o[e.id] = t));
  }),
    t_menu__updateSectionsOffsets(i),
    i.sort(function (t, e) {
      var n = parseInt(t.getAttribute("data-offset-top"), 10) || 0,
        r;
      return (parseInt(e.getAttribute("data-offset-top"), 10) || 0) - n;
    }),
  ...
  (Array.prototype.forEach.call(a, function (t) {
    ...
    t_menu__highlightNavLinks(t, i, o, r),
    t.forEach(function (e, n) {
      e.addEventListener("click", function () {
        var i = t_menu__getSectionByHref(e);
    ...
    window.addEventListener(
      "scroll",
      t_throttle(function () {
        r = t_menu__highlightNavLinks(t, i, o, r);
      }, 100),
    ),
...
function t_menu__updateSectionsOffsets(t) {
  t.forEach(function (t) {
    ...
    t.getAttribute("data-offset-top") !== e.toString() &&
      t.setAttribute("data-offset-top", e);
  });
}
function t_menu__getSectionByHref(t) {
  if (t) {
    ...
    if (!a) return null;
    var l = a.closest('.r[data-record-type="215"], .r[data-parenttplid="215"]');
    if (l) return l;
    var s = document.querySelector(o + "+ .r");
    return s ? ((a.id = s ? s.id + "_" + r : ""), a) : null;
  }
}
function t_menu__highlightNavLinks(t, e, n, r) {
  ...
  for (var u = 0; u < e.length; u++) {
    var c = parseInt(e[u].getAttribute("data-offset-top"), 10),
      d = e[u].id ? n[e[u].id] : null;
...
function t_menu__setBGcolor(t, e) {
  ...
  Array.prototype.forEach.call(n, function (t) {
    window.innerWidth > 980
      ? "yes" === t.getAttribute("data-bgcolor-setbyscript") &&
        (t.style.backgroundColor = t.getAttribute("data-bgcolor-rgba"))
      : ((t.style.backgroundColor = t.getAttribute("data-bgcolor-hex")),
        t.setAttribute("data-bgcolor-setbyscript", "yes"),
...
function t_menu__showFixedMenu(t, e) {
  var n,
    r = [".t280", ".t282", ".t450", ".t451", ".t466", ".t453"].some(
      function (t) {
        return t === e;
      },
    );
  if (!(window.innerWidth <= 980) || r) {
    ...
    if (!i) return !1;
    var o = i.querySelectorAll(e);
    Array.prototype.forEach.call(o, function (t) {
      var e = t.getAttribute("data-appearoffset");
      if (e) {
        (-1 !== e.indexOf("vh") &&
          (e = Math.floor(window.innerHeight * (parseInt(e) / 100))),
          (e = parseInt(e, 10)));
        var n = t.clientHeight;
        "number" == typeof e && window.pageYOffset >= e
          ? t.style.transform === "translateY(-" + n + "px)" &&
            t_menu__slideElement(t, n, "toBottom")
          : "translateY(0px)" === t.style.transform
            ? t_menu__slideElement(t, n, "toTop")
            : ((t.style.transform = "translateY(-" + n + "px)"),
              (t.style.opacity = "0"));
      }
    });
...
function t_menu__changeBgOpacity(t, e) {
  var n,
    r = ["t280", "t282", "t451", "t466"].some(function (t) {
  ...
  if (!(window.innerWidth <= 980) || r) {
    ...
    Array.prototype.forEach.call(o, function (t) {
      var e = t.getAttribute("data-bgcolor-rgba"),
        ...
        r = t.getAttribute("data-bgopacity"),
        i = t.getAttribute("data-bgopacity-two"),
        o = parseInt(t.getAttribute("data-menushadow"), 10) || 0;
      o /= 100;
      var a = t.getAttribute("data-menushadow-css");
      ((t.style.backgroundColor = window.pageYOffset > 20 ? n : e),
        ...
        (!o && !a)
          ...
          : a
            ? (t.style.boxShadow = a)
            : o && (t.style.boxShadow = "0px 1px 3px rgba(0,0,0," + o + ")"));
    });
  }
}
function t_menu__createMobileMenu(t, e) {
  var n = document.getElementById("rec" + t);
  if (n) {
    var r = n.querySelector(e),
      i = r ? r.getAttribute("data-mobile-burgerhook") : "",
      o = n.querySelector(e + "__mobile"),
      a = o || n.querySelector(".tmenu-mobile"),
      l = o ? e.slice(1) + "_opened" : "tmenu-mobile_opened",
      s = "t-menuburger-opened";
    if (a)
      if (r && r.classList.contains(e.slice(1) + "__mobile_burgerhook") && i) {
          ...
          if (!n.target.closest("a")) {
            if (a.classList.contains(l))
              ...
              var i = getComputedStyle(a).height,
                o = getComputedStyle(a).borderBottom || 0;
              r.style.top = i + o;
            }
            t_menu_checkOverflow(t, e);
          }
        });
      }
    (screen.width < 980 &&
      n.addEventListener("click", function (n) {
        ...
        if (r && r.classList.contains("tmenu-mobile__menucontent_fixed")) {
          var o =
              null == (i = r.closest(".r"))
                ? void 0
                : i.querySelector(".tmenu-mobile_positionfixed"),
            c = (null == o ? void 0 : o.offsetHeight) || 0;
          c && (r.style.top = c + "px");
          var d = n.target.closest(
      ...
      window.addEventListener(
        ...
        t_throttle(function () {
          if (window.innerWidth > 980) {
            if ((r && (r.style.opacity = ""), r && (r.style.display = ""), r)) {
              var n = r.getAttribute("data-top") || "";
              r.style.top = n;
            }
            a && a.classList.remove(l);
          }
...
function t_menu_checkOverflow(t, e) {
  var n = document.getElementById("rec" + t),
    r = n ? n.querySelector(e) : null;
  if (r) {
    var i = n.querySelector(e + "__mobile"),
...
function t_menu__slideElement(t, e, n) {
  var r = "toTop" === n ? 0 : e,
    ...
    o = setInterval(function () {
      ((t.style.transform = "translateY(-" + r + "px)"),
        (t.style.opacity = i.toString()),
        (i = "toTop" === n ? i - 0.1 : i + 0.1),
        (r = "toTop" === n ? r + e / 20 : r - e / 20),
        "toTop" === n &&
          r >= e &&
...
function t_menu__interactFromKeyboard(t) {
  var e = document.getElementById("rec" + t);
  if (e) {
    var n = e.querySelectorAll(".t-menu__list > li > a"),
      r = e.querySelectorAll(".t-menu__list > li li"),
      i = 9,
      o = 13,
      a = 27,
      l = 32,
      ...
      f = function t(e) {
        e.addEventListener("keydown", function (t) {
          var e = this.parentNode.querySelector(".t-menusub__list");
          switch (t.keyCode) {
            case i:
              if (!t.shiftKey && s <= n.length - 2) c(s + 1);
              else {
                if (!(t.shiftKey && s > 0)) return;
                c(s - 1);
              }
              break;
            case o:
      ...
      _ = function t(e) {
        var n = e.parentNode.querySelector(".t-menusub__menu");
        e.addEventListener("click", function (t) {
          if (
            ...
            t_menusub__showSubmenu(e, n, i);
          } else this.setAttribute("aria-expanded", "false");
          return (t.preventDefault(), !1);
        });
      },
      p = function t(e) {
        var r = e.closest(".t-menusub__menu"),
          f = !1;
        e.addEventListener("keydown", function (t) {
          ...
          switch (t.keyCode) {
            case i:
              f = !0;
              var m = e.querySelectorAll(".t-menusub__link-item").length;
              if (t.shiftKey)
                0 === u ? (c(s), t_menusub__hideSubmenu(r)) : d(e, u - 1);
              else if (u === m - 1) {
          ...
          f && (t.preventDefault(), t.stopPropagation());
        });
      };
    (Array.prototype.forEach.call(n, function (t) {
      var e;
      (m(t),
        f(t),
        !t.parentNode.querySelector(".t-menusub__menu") ||
          window.isMobile ||
...
function t_menu__isBlockVisible(t) {
  var e = window.innerWidth,
    n = t.getAttribute("data-screen-min"),
    r = t.getAttribute("data-screen-max");
  return !(n && e < parseInt(n, 10)) && !(r && e > parseInt(r, 10));
}
