...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  ...
  switch (e) {
    case "left":
      ...
      break;
    case "top":
      var T = r.closest(".t396__artboard"),
        R = T ? T.getAttribute("data-artboard-proxy-min-offset-top") : "0",
        W = T ? T.getAttribute("data-artboard-proxy-min-height") : "0",
        C = T ? T.getAttribute("data-artboard-proxy-max-height") : "0",
        H = function t(e) {
      ...
      if (
        ((F = "grid" === h ? "grid" : "window"),
        (S = "grid" === h ? parseFloat(R) : 0),
        (k = "grid" === h ? parseFloat(W) : parseFloat(C)),
      ...
      (f && "window" !== F && (y *= z),
        ...
        (y = S + y));
      var D = t396_ab__getFieldValue(T, "height_vh"),
        j = t396_ab__getFieldValue(T, "height"),
        G = t396_ab__getHeight(T),
        Z;
      if (
        ...
        "center" === w &&
          ...
          u ||
            ...
            "window" === F ||
            "stretch" !== l ||
            ((k = Z ? (Z > G ? Z : G) : T.clientHeight), (k /= z)),
          (y = k / 2 - E / 2 + y)),
        "bottom" === w &&
          ((E = H(r)),
          f &&
