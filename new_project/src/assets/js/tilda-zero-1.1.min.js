  ...
  if (e) {
    ...
    if (i)
      try {
        ...
        return (
          console.error("Error parsing form inputs textarea value:", n, i),
          []
        );
      }
  }
  var r = t.querySelector(".tn-atom__inputs-data");
  if (r) {
    var o = r.getAttribute("data-value");
    if (o)
      try {
        return JSON.parse(o);
      } catch (n) {
        return (console.error("Error parsing form inputs data:", n, o), []);
      }
  }
  return [];
}
...
function t396__setGlobalScaleVariables(t, e, i) {
  ...
  return (
    _ && !window.tn.isEditMode && _.style.setProperty("--zoom", l.toString()),
    l
  );
}
...
function t396__updateBackdropFilterOnImage(t) {
  if (t) {
    var e = t,
      ...
      o = "";
    (r &&
      ((e = r), (o = window.getComputedStyle(e).webkitBackdropFilter || "")),
  ...
  if (i) {
    ...
    if ("yes" !== i.getAttribute("data-scale-off") || !a || "edit" === o) {
      ...
      switch (e) {
        ...
        case "inputs":
          try {
            ((l = t396_elem__getFormInputsValue(i)),
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  ...
  var y = parseInt(i),
    ...
    E,
    I,
    k = t396__getCurrentScaleFactor(n);
  switch (e) {
    case "left":
      var z,
      ...
      (!u && d ? "grid" === h && c && (y *= k) : (y = A + y),
        ...
        f &&
          "window" !== F &&
          (y += ((x = t396_elem__getWidth(r)) * k - x) / 2));
      break;
    case "top":
      ...
      if (
        ...
        (I = "grid" === h ? parseFloat(W) : parseFloat(H)),
        "%" === t396_elem__getFieldValue(r, "topunits") && (y = I * (y / 100)),
        v)
      ) {
        var M = parseInt(t396_group__getFieldValue(b, "top"), 10),
          N;
        ("%" === t396_group__getFieldValue(b, "topunits") &&
          (M = t396_roundFloat((I * M) / 100)),
          (y -= M));
        break;
      }
      (f && "window" !== F && (y *= k),
        g && "window" !== F && (S = "stretch" === l ? 0 : S / k),
        (y = S + y));
      ...
      if (
        ...
        "center" === w &&
          ...
          u ||
            ...
            "window" === F ||
            "stretch" !== l ||
            ((I = Z ? (Z > G ? Z : G) : R.clientHeight), (I /= k)),
          (y = I / 2 - E / 2 + y)),
        "bottom" === w &&
          ((E = C(r)),
          f &&
