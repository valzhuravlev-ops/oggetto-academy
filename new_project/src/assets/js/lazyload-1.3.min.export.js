  ...
  if (null != e) {
    ...
    if ("IMG" == t)
      ...
      var o = getComputedStyle(e)
          ...
          .replace(/"/gi, ""),
        i;
      if ("contain" == getComputedStyle(e)["background-size"])
        var n = "-/contain/";
      else var n = "-/cover/";
    } else var n = "-/cover/";
    if (
      !(
        ...
        (o.indexOf("-/empty/") > 0 && o.indexOf("-/resizeb/") > 0)
      )
    ) {
      ...
      if (l > 0 && a > 0) {
        ...
        if (
          ...
          c > 0 &&
          (r[0] > 0 || r[1] > 0) &&
          ((r[0] > 0 && s > r[0]) || (r[1] > 0 && c > r[1])) &&
          ((r[0] > 0 && s - r[0] > 100) || (r[1] > 0 && c - r[1] > 100))
        ) {
          var d =
            o.slice(0, l) +
            (r[0] > 0 ? s : "") +
...
(!(function (e, t) {
  ...
  function n(e, t, o) {
    ...
    function u() {
      var n;
      return (
        (n = t === window ? a() + window.pageXOffset : c(t) + a()) <= c(e) - o
      );
    }
    function _() {
      var o,
  ...
  function a(e) {
    ...
    return (
      t.forEach(function (e) {
        ((e.isSkipByPosition =
          null === e.offsetParent &&
          0 === r(e, ".t396__carrier-wrapper").length &&
          "fixed" !== e.getAttribute("data-content-cover-parallax")),
          (e.isNotUnderScreenRange =
            0 === r(e, ".t-rec[data-screen-max]").length &&
            0 === r(e, ".t-rec[data-screen-min]").length));
      }),
      t
    );
  }
  function r(e, t) {
    for (var o = []; (e = e.parentNode) && e !== document; )
      (t && !e.matches(t)) || o.unshift(e);
    return o;
  }
  function s(e, t) {
  ...
  function d(e, t, o, n) {
    var i = t.getAttribute("data-" + n),
      ...
      a = e.tagName;
    return "IMG" === a
      ? (l && e.setAttribute("srcset", l), void (i && e.setAttribute("src", i)))
      : "IFRAME" === a
        ? void (i && e.setAttribute("src", i))
        : void (e.style.backgroundImage = "url(" + i + ")");
  }
  function u(e, t) {
    return function () {
  ...
  return (
    (_.prototype._showOnLoad = function (e) {
      function n() {
        null !== l &&
          (l.callback_load && l.callback_load(e),
          d(e, e, l.data_srcset, l.data_src),
          l.callback_set && l.callback_set(e),
          c(e, l.class_loading),
          s(e, l.class_loaded),
          o(i, "load", n));
      }
    ...
    (_.prototype._loopThroughElements = function () {
      ...
      for (e = 0; l > e; e++)
        ((t = i[e]),
          (o.skip_invisible && t.isSkipByPosition) ||
            (n(t, o.container, o.threshold) &&
              (o.show_while_loading
      ...
      for (; a.length > 0; )
        (i.splice(a.pop(), 1),
          o.callback_processed && o.callback_processed(i.length));
    ...
    (_.prototype._stopScrollHandler = function () {
      this._isHandlingScroll &&
        ...
        o(this._settings.container, "scroll", this._handleScrollFn));
    }),
