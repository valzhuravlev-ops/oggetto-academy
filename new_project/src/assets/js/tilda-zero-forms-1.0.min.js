...
function t_zeroForms__createForm(t, e, r, o) {
  ...
  (m.classList.add("js-successbox"),
    ...
    m.classList.add("oggy-text"),
    m.classList.add("oggy-text_sm"),
...
function t_zeroForms__parseIntoElement(t, e, r, o, n, i) {
  ...
  switch ((f.classList.add("t-input-block"), r.li_type)) {
    ...
    case "ur":
      ...
      break;
    case "tx":
      ((b = document.createElement("div")).classList.add("oggy-text"),
...
function t_zeroForms__generateSubtitle(t, e, r) {
  ...
  ("LABEL" === i.tagName && (i.style.display = "block"),
    ...
    i.classList.add("oggy-descr"),
    i.classList.add("oggy-descr_xxs"),
      ...
      i.forEach(function (n, i) {
        ...
        if (
          ...
          (b.classList.add("t-img-select__text"),
            b.classList.add("oggy-text"),
            b.classList.add("oggy-text_xs"),
            (b.textContent = m),
...
function t_zeroForms__createQuantityRange(t, e, r, o, n) {
  ...
  (s.classList.add("t-range__value-txt"),
    s.classList.add("oggy-descr"),
    s.classList.add("oggy-descr_xxs"),
...
function t_zeroForms__createRangeField(t, e, r) {
  ...
  return (
    ...
    o.classList.add("oggy-descr"),
    o.classList.add("oggy-descr_xxs"),
    e && (o.style.color = e),
    (o.textContent = r),
    o
  );
...
function t_zeroForms__createErrorBox(t, e, r) {
  ...
  (i.classList.add("t-form__errorbox-text"),
    i.classList.add("oggy-text_xs"),
    i.classList.add("oggy-text"),
...
function t_zeroForms__getBottomText(t, e, r, o, n) {
  ...
  if (
    ...
    (s.classList.add("oggy-text"),
      s.classList.add("oggy-text_xxs"),
