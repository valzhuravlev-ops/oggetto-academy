...
function t396_isBlockVisible(t) {
  var e = window.innerWidth,
    r = t.getAttribute("data-screen-min"),
    o = t.getAttribute("data-screen-max");
  return !(r && e < parseInt(r, 10)) && !(o && e > parseInt(o, 10));
}
...
function t396_elem__getFormInputsValue(t) {
  var e = t.querySelector(".tn-atom__inputs-textarea");
  if (e) {
    var r = e.value;
    if (r)
      try {
        ...
        return (
          console.error("Error parsing form inputs textarea value:", i, r),
          []
        );
      }
  }
  var o = t.querySelector(".tn-atom__inputs-data");
  if (o) {
    var n = o.getAttribute("data-value");
    if (n)
      try {
        return JSON.parse(n);
      } catch (i) {
        return (console.error("Error parsing form inputs data:", i, n), []);
      }
  }
  return [];
}
var t_zeroForms__waitForResources = function t(e) {
  try {
...
function t_zeroForms__init(t, e, r) {
  var o = document.getElementById("rec" + t),
    n =
      '.tn-elem[data-fe-elem-id="' +
      e +
      '"], .tn-elem[data-elem-id="' +
      e +
      '"]',
    i = o ? o.querySelector(n) : null;
  if (i && document.contains(i)) {
    var a = t_zeroForms__getTildaMode(),
      s = document.querySelector('script[src*="tilda-blocks-2.7"]');
    t_zeroForms__waitForTN(function () {
      document.contains(i) &&
        (t_zeroForms__renderForm(i, r, t, a),
        t_zeroForms__waitForResources(t).then(function () {
          (t396_elem__renderViewOneField(s ? $(i) : i, "left"),
            t396_elem__renderViewOneField(s ? $(i) : i, "top"));
        }));
    });
  }
}
...
function t_zeroForms__renderForm(t, e, r, o) {
  ...
  if (
    ...
    e || (e = t396_elem__getFormInputsValue(t));
    var s = t_zeroForms__fromObjToArray(e),
      l = t.querySelector(".tn-atom");
    if ("zero" === o || "edit" === o) l.innerHTML = "";
    else if (l.querySelector(".t-form")) return;
    var _ = t_zeroForms__createForm(r, o, s, t);
    if (_) {
      (l.insertAdjacentElement("beforeend", _),
        t_zeroForms__placeFormIntoColumns(t));
      var d = document.createEvent("Event");
      (d.initEvent("render", !0, !0),
        t.dispatchEvent(d),
...
function t_zeroForms__createForm(t, e, r, o) {
  ...
  var S =
      window.t_zeroForms__isMobile || "ontouchend" in document
        ? "orientationchange"
        : "resize",
    k = t_zeroForms__getTildaMode(),
    I = 0;
  return (
    window.addEventListener(S, function () {
      I ||
        (I = setTimeout(function () {
          (t_zeroForms__updateCurrentResolution(t, k),
...
function t_zeroForms__generateInputsBlock(t, e, r, o, n) {
  ...
  return (
    ...
    s.insertAdjacentElement(
      "beforeend",
      t_zeroForms__createErrorBox(t, o, "middle"),
    ),
    s.insertAdjacentElement(
      "beforeend",
      ...
      ((b = t_zeroForms__createRadioImage(r, o, p)),
        ...
        t_zeroForms__onRender(e, !1, function () {
          t_zeroForms__onFuncLoad("t_input_imgselect_init", function () {
            (t_input_imgselect_init(t, r.lid),
              t_input_imgselect_invertColor(t));
          });
        }));
      break;
    case "cb":
    ...
    case "fr":
      if (
        ...
        var S = document.createElement("style"),
          k = t_zeroForms__createSelector(t, i, ".t-input-group_fr");
        ((S.textContent =
          k +
          "{background-color:" +
          o.inputfrbgcolor +
...
function t_zeroForms__createOwnAnswer(t, e, r, o, n, i, a) {
  (t.classList.add("t-input__own-answer-input"),
    (t.defaultRadioValue = t.value));
  var s = document.createElement("div");
...
function t_zeroForms__createOwnAnswerInput(t, e, r, o) {
  ...
  return (
    (o || "zero" === i) && n.classList.add("t-input__own-answer--active"),
    n
  );
}
...
function t_zeroForms__createErrorBox(t, e, r) {
  if ("zero" === window.tildamode) return document.createElement("div");
  var o = document.createElement("div");
  o.classList.add("t-form__errorbox-" + r);
  var n = document.createElement("div");
  (n.classList.add("js-errorbox-all"),
    n.classList.add("t-form__errorbox-wrapper"),
    (n.style.display = "none"),
    o.insertAdjacentElement("beforeend", n));
  var i = document.createElement("div"),
    a;
  (i.classList.add("t-form__errorbox-text"),
    i.classList.add("t-text_xs"),
    i.classList.add("t-text"),
    ["all", "req", "email", "name", "phone", "string"].forEach(function (t) {
      var r = document.createElement("p");
      (r.classList.add("t-form__errorbox-item"),
        r.classList.add("js-rule-error"),
        r.classList.add("js-rule-error-" + t),
        "all" !== t && "string" !== t && (r.textContent = e["formerr" + t]),
        i.insertAdjacentElement("beforeend", r));
    }),
    n.insertAdjacentElement("beforeend", i));
  var s = document.createElement("div");
  return (
    s.classList.add("tn-form__errorbox-close"),
    s.classList.add("js-errorbox-close"),
    s.insertAdjacentElement(
      "beforeend",
      t_zeroForms__createErrorBoxBtn("left"),
    ),
    s.insertAdjacentElement(
      "beforeend",
      t_zeroForms__createErrorBoxBtn("right"),
    ),
    n.insertAdjacentElement("beforeend", s),
    ...
    //   path: "tilda-zero-form-errorbox.min.css",
    //   type: "link",
    // }),
    o
  );
...
function t_zeroForms__createErrorBoxBtn(t) {
  ...
  return (
    e.classList.add("tn-form__errorbox-close-line"),
    e.classList.add("tn-form__errorbox-close-line-" + t),
    e
  );
}
  ...
  if (e) {
    ...
    (i.initEvent("input", !0, !0),
      n
        ...
        : o.value >= 0 &&
          ((o.value = Number(o.value) + 1), o.dispatchEvent(i)));
  }
}
...
function t_zeroForms__moveFieldToNextRow(t) {
  var e;
  t_zeroForms__createArrWithAllRows(t, "t-input-group_inrow").forEach(
    function (t) {
      var e = !1;
      if (
        (t.forEach(function (t) {
