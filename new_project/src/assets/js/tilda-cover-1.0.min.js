    ...
    if (r && "935" !== n) {
      ...
      ((window.t_cover__isMobile || "ontouchend" in document) && t)
        ...
        : window.t_cover__isMobile && y
          ...
          : g > p + h &&
            (t_cover__setRecalculatedHeight(o, p),
...
function t_cover__setRecalculatedHeight(e, t) {
  ...
  var i = t_cover__getHeightFromAttr(r),
    ...
    l = window.innerWidth <= 568 ? 50 : 100;
  ((d || _) && ((u = 0), (l = 0)), (t += u) > 1e3 && (t += l));
  var v = t > i ? t : i,
    s = 0,
    g = [
      ".t-cover",
      ...
      Array.prototype.slice.call(e.querySelectorAll(t)).forEach(function (e) {
        ...
        v < document.documentElement.clientHeight
          ? ((s = 0.2 * document.documentElement.clientHeight),
            (e.style.height = v + s + "px"))
          : e && (e.style.height = v + "px");
      });
    }),
    o.setAttribute("data-content-cover-updated-height", v + s + "px"));
