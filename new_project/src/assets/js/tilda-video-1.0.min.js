          ...
          : "vimeo" === t
            ...
            : "kinescope" === t
              ...
              : "boomstream" === t
                ...
                : (console.warn("unsupported video type:", t),
                  Promise.reject(null));
}
...
function t_video__doVimeoCommand(e, t) {
  e.contentWindow.postMessage(
    JSON.stringify({ method: t, value: "true" }),
    "*",
  );
}
function t_video__doBoomstreamCommand(e, t, o) {
  e.contentWindow.postMessage(
    { code: o, method: "action", action: t, data: "" },
    "*",
  );
}
...
function t_video__initPlayer__youtube(e) {
  ...
  return new Promise(function (o, i) {
    ...
    if (!n) return i(new Error(t + ": IFrame Element not Found"));
            ...
            onReady: function i(r) {
              var a = r.target,
                d = {
                  ...
                  mute: function e() {
                    return console.warn(t + " Mute is not implemented");
                  },
                  unmute: function e() {
                    return console.warn(t + " Unmute is not implemented");
                  },
                  videoEl: n,
                  player: a,
                };
...
function t_video__initPlayer__vimeo(e) {
  ...
  return new Promise(function (o, i) {
    ...
    var r = {
      pause: function e() {
        return t_video__doVimeoCommand(n, "pause");
      },
      play: function e() {
        return t_video__doVimeoCommand(n, "play");
      },
      mute: function e() {
        return console.warn(t + " Mute is not implemented");
      },
...
function t_video__initPlayer__vkvideo(e) {
  ...
  return new Promise(function (o, i) {
    ...
    if (!n) return i(new Error(t + ": IFrame Element not Found"));
    (t_onFuncLoad("t_loadJsFile", function () {
      t_loadJsFile("https://vkvideo.ru/js/api/videoplayer.js");
    }),
      t_onFuncLoad("VK", function () {
        var i = VK.VideoPlayer(n),
          r = {
            videoType: t,
            pause: function e() {
              return i.pause();
...
function t_video__initPlayer__rutube(e) {
  ...
  return new Promise(function (o, i) {
    ...
    var r = {
      videoType: t,
      pause: function e() {
        return t_video__doRutubeCommand(n, "pause");
      },
      play: function e() {
        return t_video__doRutubeCommand(n, "play");
      },
      mute: function e() {
        return console.warn(t + " Mute is not implemented");
      },
...
function t_video__initPlayer__htmlVideo(e, t) {
  return new Promise(function (o, i) {
    ...
    if (!n) return i(new Error(t + ": Video Element not Found"));
    var r = {
      videoType: t,
      pause: function e() {
        return n.pause();
...
function t_video__initPlayer__boomstream(e) {
  ...
  return new Promise(function (o, i) {
    ...
    if (!n) return i(new Error(t + ": IFrame Element not Found"));
    var r,
      a = /boomstream.com\/(?:balancer\/)?([A-Za-z0-9-]+)/,
      d = n.src.match(a);
    if (!d) return i(new Error(t + ": VideoID not Found"));
    var l = {
      pause: function e() {
        return t_video__doBoomstreamCommand(n, "pause", d[1]);
      },
      play: function e() {
        return t_video__doBoomstreamCommand(n, "play", d[1]);
      },
      mute: function e() {
        return console.warn(t + " Mute is not implemented");
      },
...
function t_video_lazyload_init() {
  if ("IntersectionObserver" in window) {
    ...
    var o = document.querySelectorAll(
        ".t-video-lazyload:not(.t-video-no-lazyload)",
      ),
...
function t_video_lazyload__addVideo(e) {
  var t = window.matchMedia("(max-width: 640px)").matches,
    ...
    n = e.getAttribute("data-videolazy-id"),
    r = n ? n.trim() : "";
  "youtube" === i &&
    "string" == typeof r &&
    (r = (r = r.replace(/^v=/, "")).replace(/[&?]+$/, ""));
  var a = e.getAttribute("data-videolazy-hash"),
    d = a ? a.trim() : "",
    l,
    u = e.getAttribute("data-blocklazy-id") || "",
    c = "youtubeiframe",
    s = "kinescopeiframe",
    _ = e.getAttribute("data-videolazy-two-id");
  _ && (c += "_" + _ + "_");
  var v = e.getAttribute("data-videolazy-nocontrols"),
    m = e.getAttribute("data-videolazy-play"),
    y = e.getAttribute("data-videolazy-mute"),
    f = e.getAttribute("data-videolazy-api"),
    p = e.getAttribute("data-videolazy-image"),
    h = e.getAttribute("data-videolazy-inline"),
    w = "",
    b = "100%",
    g = e.getAttribute("data-videolazy-height"),
    z = e.getAttribute("data-videolazy-mob-height");
  if (
    (!t && g && -1 === g.indexOf("vh") && (b = g),
    t && z && -1 === z.indexOf("vh") && (b = z),
    ...
    if ((e.setAttribute("data-videolazy-load", "true"), "youtube" === i)) {
      ...
      -1 !== r.indexOf("vd.tilda.cc")
        ? (A = r)
        : ((w += "rel=0&fmt=18&html5=1&showinfo=0"),
          (w += m ? "&autoplay=1" : ""),
          (w += y ? "&mute=1" : ""),
          (w += "yes" === v ? "&controls=0" : ""),
          (A =
            "https://www.youtube.com/embed/" +
            (r = (r += -1 !== r.indexOf("?") ? "&" : "?").replace(
      ...
      var M =
          /(?:video|video_ext\.php\?oid=|clip=?|)(-?\d+)_(\d+)|oid=(-?\d+)&id=(\d+)(?:.*?hash=([a-f0-9]+))?/,
        T = r.match(M),
        F = "",
        L = "";
      (T && ((F = T[1] || T[3]), (L = T[2] || T[4]), !d && T[5] && (d = T[5])),
        (w += m ? "&autoplay=1" : ""),
        (w += y ? "&muted=1" : ""),
        (w += d ? "&hash=" + d : ""),
        (w += f ? "&js_api=1" : ""),
        e.insertAdjacentHTML(
          "afterbegin",
          '<iframe src="https://vkvideo.ru/video_ext.php?oid=' +
            F +
            "&id=" +
            L +
            "&hd=2" +
  ...
  if (
    (e.closest(".t116, .t1148") ||
      "540px" !== g ||
      t_video_lazyload__setHeight(e),
    g &&
      z &&
    ...
    function q(e) {
      if (e && e.data && "string" == typeof e.data) {
        ...
        "player:ready" === t.type &&
          ...
          t_video__doRutubeCommand(j, "play"));
      }
    }
    (t_video__doRutubeCommand(j, "changeState"),
...
function t_video_lazyload__setHeight(e) {
  if (e) {
    ...
    var i = Math.round(0.5625 * e.offsetWidth);
...
function t_video_lazyload__setMobileHeight(e) {
  ...
  if (e) {
    var n = e.querySelector("iframe") || n.querySelector("video");
    if (n) {
      var r = t ? i : o;
...
function t_video__createPlayer(e, t) {
  ...
  var n = i.getAttribute("data-videolazy-type");
  return (t_video_lazyload__addVideo(i), t_videoPlayer__init(e, n));
}
function t_video_lazyload__overwriteParams(e, t) {
  ...
  return (
    ...
    n && e.setAttribute("data-videolazy-hash", n),
    a && e.setAttribute("data-blocklazy-id", a),
    c && e.setAttribute("data-videolazy-play", "true"),
    _ && e.setAttribute("data-videolazy-mute", "true"),
    !0 === d && e.setAttribute("data-videolazy-nocontrols", "false"),
    !1 === d && e.setAttribute("data-videolazy-nocontrols", "yes"),
    m && e.setAttribute("data-videolazy-api", "true"),
...
((window.t_video__createPlayer = t_video__createPlayer),
  ...
  t_onReady(function () {
    t_onFuncLoad("t_video_lazyload_init", function () {
      var e;
      document.querySelectorAll(".t-video-lazyload:not(.t-video-no-lazyload)")
        .length && t_video_lazyload_init();
    });
  }));
