!(function () {
  ...
  function g(t) {
    ...
    if (
      n > "?" &&
      ((m.pagequery = n.substring(1).toLowerCase()),
      ~m.pagequery.indexOf("utm_"))
    ) {
      var o,
        i = m.pagequery.split("&");
      Array.prototype.forEach.call(i, function (e) {
        (o = e.split("=")).length > 1
          ? "utm_referrer" !== o[0] ||
            (m.referrer && !~m.referrer.indexOf("ohio8.v"))
            ? (m.params[o[0]] = o[1])
            : (m.referrer = o[1])
          : (m.params[o[0]] = "");
      });
  ...
  function p(e) {
    var t = "https://stat.tildaapi." + L() + "/event/",
      i;
    h ||
      ((n("tildasid") || "") != m.sessionid &&
        o("tildasid", m.sessionid, { expires: 1800, path: "/" }));
    ("" === m.referrer && (m.referrer = n("previousUrl") || ""),
      ...
      m.page ||
        ...
        window.location.hash &&
          ...
          (m.page += window.location.hash)),
      "/" === m.page.substring(0, 1) &&
        (m.page = window.location.hostname + m.page));
    var a = f(m),
    ...
    (r.open("POST", t, !0),
      ...
      m.page &&
        ...
        ((m.referrer = m.page),
        h || o("previousUrl", m.page, { path: "/", expires: 1800 })),
      (m.page = ""),
  ...
  var j = setInterval(function () {
      if (
        ...
        ((e.src =
          "https://static.tildacdn." + L() + "/js/tilda-errors-1.0.min.js"),
          (e.async = !0),
      ...
      S(function () {
        ...
        ((e.async = !0),
          ...
          (e.src =
            ...
            L() +
            "/js/tilda-performance-1.0.min.js"),
