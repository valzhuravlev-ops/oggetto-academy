...
function t604__UpdateSliderArrowsHeight(recid) {
  ...
  if (activeItem) {
    ...
    var itemPaddingBottom =
      parseInt(getComputedStyle(activeItem).paddingBottom) || 0;
    var height = itemPaddingTop + itemPaddingBottom - offsetForVideoBtns;
    if (
      separator &&
      separator.hasAttribute("data-slider-image-height") &&
      activeItem.clientHeight === 0
    ) {
      height =
        parseInt(separator.getAttribute("data-slider-image-height")) - height;
    } else {
