...
function t_zoom__initFullScreenImgOnClick() {
  document.addEventListener("click", function (t) {
    var e = t.target.closest(
      '.t-zoomable:not([data-img-zoom-url=""]), .t-slds__thumbs_gallery-zoomable',
    );
    e && t_zoomHandler(e);
  });
...
function t_zoomHandler(t) {
  ...
  (i.classList.add("t-carousel__zoomer__track"),
    a.appendChild(i),
    t_zoom__appendPreloaderToElement(a));
...
function t_zoom__updateSlidesHeight() {
  var t = document.querySelectorAll(
      ".t-carousel__zoomer__item .t-carousel__zoomer__img",
    ),
    e = document.querySelector(".t-zoomer__wrapper");
  if (e && t.length) {
...
function t_zoom__addingImgsIntoCarousel(t) {
  ...
  Array.prototype.forEach.call(o, function (t, e) {
    ...
    (("IMG" !== t.nodeName && "DIV" !== t.nodeName) ||
      ...
      (c = t.getAttribute("data-img-zoom-descr") || "")),
      n &&
    ...
    if (
      ...
      l
        ? (f.classList.add("t-img"),
          ...
          (0 !== e && e !== o.length - 1) ||
            f.setAttribute("data-lazy-rule", "skip"))
        : (f.src = s),
      m.appendChild(u),
      u.appendChild(f),
      ...
      (p.classList.add("t-zoomer__comments"),
        n && p.appendChild(_),
        c && p.appendChild(d),
        m.appendChild(p));
    }
...
function t_zoom__createAndLoopSlider(t) {
  ...
  if (o && r.length) {
    ...
    (Array.prototype.forEach.call(r, function (t) {
      ...
      var s = n + c;
      (l && (l.style.height = c + "px"),
        (e.style.maxHeight = document.documentElement.clientHeight - s + "px"));
    ...
    i &&
      ...
      d && t_zoom__preloadNextSlide(d, e));
  }
}
...
function t_zoom__getSlideList(t) {
  return Array.from(
    t.querySelectorAll(
      ".t-carousel__zoomer__item:not(:first-child):not(:last-child)",
    ),
  );
}
...
function t_zoom_checkToScaleInit(t) {
  ...
  var n =
      t.hasAttribute("data-original-svg-height") ||
      t.hasAttribute("data-original-svg-width"),
    a =
      parseInt(t.getAttribute("data-original-svg-height"), 10) ||
      t.naturalHeight,
    i =
      parseInt(t.getAttribute("data-original-svg-width"), 10) || t.naturalWidth;
  -1 === t.src.indexOf(".svg") || window.isIE || n
    ? o < a || e < i
      ? (!window.isDoubletapScaleAdded &&
          window.t_zoom__isMobile &&
  ...
  fetch(r)
    ...
    .then(function (r) {
      ...
      var _ = e < l || o < i,
        ...
        u;
      (((d || m) && !_) ||
        ((t.style.width = i + "px"), (t.style.height = l + "px")),
        _
          ? (!window.isDoubletapScaleAdded &&
              window.t_zoom__isMobile &&
              t_zoom_doubletapScaleInit(),
    ...
    "y" !== e.getAttribute("data-zoom-scale-init") &&
      ...
      t.addEventListener(
        ...
        function (e) {
          ...
          ((window.t_zoom__isMobile &&
            e.target.closest(".t-zoomer__scale") &&
            a) ||
            (!window.t_zoom__isMobile &&
              a &&
              !e.target.closest(
                ".t-zoomer__close, .t-carousel__zoomer__control",
              ))) &&
...
function t_zoom_unscale() {
  var t = document.querySelectorAll(
    ".t-zoomer__wrapper.scale-active, .t-carousel__zoomer__inner.scale-active",
  );
  Array.prototype.forEach.call(t, function (t) {
  ...
  if (e) {
    ...
    if (r) {
      ...
      window.t_zoom__isMobile &&
        (l = r.getAttribute("data-max-comment-height") || l);
      var c = i + l;
      ((n.onmousemove = null),
        (n.ontouchmove = null),
        (n.style.transform = ""),
...
function t_zoom_lockScroll() {
  ...
  if (
    ((window.t_zoom__isiOS &&
      11 === window.t_zoom__iOSMajorVersion &&
      !window.MSStream) ||
      t) &&
...
function t_zoom_setModalColor(t, e) {
  var o = "#ffffff",
    r = "#000000",
    n = t.getAttribute("data-bg-color"),
    a = n || o,
    i;
  ((a =
    -1 !== a.indexOf("-gradient(")
      ? t_zoom_getFirstColorFromGradient(a)
      : t_zoom_hexToRgb(a)),
    document.getElementById("allrecords") !==
      document.querySelector(
        ".t-catalog__product-snippet, .t-store__product-snippet",
      ) &&
      document
  ...
  var l = e.closest(".t-popup");
  if (l) {
    var c = l.style.backgroundColor;
    c && (a = c);
  }
  var s = document.querySelector(".t-zoomer__container"),
    _ = document.querySelectorAll(".t-zoomer__wrapper svg"),
    d = document.querySelectorAll(".t-zoomer__close, .t-zoomer__scale"),
    m = s.querySelectorAll(".t-carousel__zoomer__arrow__wrapper"),
    u,
    f,
    p = document.querySelectorAll(".t-zoomer__title, .t-zoomer__descr"),
    y = "black" === t_zoom_luma_rgb(a) ? r : o;
  (y === r
    ? ((u = o),
      (f = "rgba(1, 1, 1, 0.3)"),
    ...
    Array.prototype.forEach.call(_, function (t) {
      ...
      e.length > 0 &&
        Array.prototype.forEach.call(e, function (t) {
          (t.getAttribute("stroke") && t.setAttribute("stroke", u),
            t.getAttribute("fill") && t.setAttribute("fill", u));
        });
    }),
...
function t_zoom_luma_rgb(t) {
  ...
  return o.length < 3 || 0.2126 * o[0] + 0.7152 * o[1] + 0.0722 * o[2] < 128
    ? "black"
    : "white";
}
function t_zoom_hexToRgb(t) {
  ...
  var o,
    r = /^var\((--uc-color-color-[a-zA-Z0-9]+),\s*(.+)\)$/.exec(t),
    n = t;
  if (r && r[1]) {
    var a = r[1],
      i;
    n = window.getComputedStyle(document.body).getPropertyValue(a) || r[2];
  }
  var l = /^#?([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})$/i.exec(n),
    c;
  return l
    ? l.splice(1).map(function (t) {
...
function t_zoom_getFirstColorFromGradient(t) {
  ...
  var o,
    r =
      /(?:var\((--uc-color-color-[a-zA-Z0-9]+),)?(?:(rgb)a?\(([0-9]+),([0-9]+),([0-9]+)(?:,[0-9.%]+)?\))|(?:(#)([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2}))/.exec(
        t,
      ),
    n,
    a;
  if (!r) return e;
  if (r[2] && r[3] && r[4] && r[5]) ((n = r[2]), (a = [r[3], r[4], r[5]]));
  else {
    if (!(r[6] && r[7] && r[8] && r[9])) return e;
    ((n = r[6]), (a = [r[7], r[8], r[9]]));
  }
  var i = r[1];
  if (i) {
    var l,
      c = window.getComputedStyle(document.body).getPropertyValue(i);
    if (c) {
      var s =
          /^rgba?\(([0-9]+),\s*([0-9]+),\s*([0-9]+)(?:,\s*[0-9.%]+)?\)$/i.exec(
            c,
          ),
        _ = /^#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})$/i.exec(c);
      (s && ((a = s.splice(1)), (n = "rgb")),
        _ && ((a = _.splice(1)), (n = "#")));
    }
  }
  return a.map(function (t) {
    return parseInt(t, "#" === n ? 16 : 10);
  });
}
