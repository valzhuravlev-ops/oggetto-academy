...
!(function (e, t) {
      ...
      "undefined" != typeof Reflect && Reflect.get
        ...
        : function (e, t, a) {
            ...
            if (i) {
              ...
              return n.get ? n.get.call(arguments.length < 3 ? e : a) : n.value;
            }
  ...
  var z = function () {
      ...
      try {
        var t;
        return null != (e = window.console) && "function" == typeof e.log
          ? (t = e).log.apply(t, arguments)
          : void 0;
      } catch (e) {}
    },
    A = function () {
      var e;
      if (!(null != (e = window.console) ? e.debug : void 0))
        return z.apply(
          void 0,
    ...
    C = function () {
      var e;
      if (!(null != (e = window.console) ? e.warn : void 0))
        return z.apply(
          void 0,
    ...
    j = Object.freeze({ __proto__: null, isWindowDefined: T });
  function D(e, t, a) {
    var i, n;
    if (
      "RequestThrottledError" ===
        (null == e ||
        null === (i = e.responseJSON) ||
        void 0 === i ||
        null === (n = i.error) ||
        void 0 === n
          ? void 0
          : n.error_code) &&
      a.attempt < t.throttledAttempts
    ) {
      var r = Number.parseFloat(e.getResponseHeader("retry-after"));
      return {
        shouldRetry: !0,
        retryTimeout: Number.isFinite(r) ? Math.ceil(1e3 * r) : 15e3,
      };
    }
    return -1 !== ["error", "timeout"].indexOf(e.statusText) &&
      a.attempt < t.attempts
      ? {
          shouldRetry: !0,
          retryTimeout: Math.round(
            t.baseTimeout * Math.pow(t.factor, a.attempt),
          ),
        }
      : { shouldRetry: !1 };
  }
  function I(e, t, i, n) {
    var o = ["baseTimeout", "attempts", "factor"].find(function (e) {
      return void 0 === i[e];
    });
    if (o)
      return (
        C('Option key "'.concat(o, '" is missed in the retry config.')),
        e
      );
    ((n = { attempt: n.attempt || 0, timeoutId: null, jqXHR: null }),
      (i = r(
        {
          baseTimeout: null,
          attempts: null,
    ...
    var l = (function (e, t, i, n) {
        return function () {
          var o = a.default.Deferred();
          function l() {
            n.jqXHR = a.default
              .ajax(t)
              .retry(i, r(r({}, n), {}, { attempt: n.attempt + 1 }))
              .done(o.resolve)
              .fail(o.reject);
          }
          for (
            ...
            f[h] = arguments[h];
          c
            ? (null === (s = i.onAttemptFail) ||
                void 0 === s ||
                s.call(i, { attempt: n.attempt }),
              i.debugUploads &&
                z(
                  "Attempt failed. Retry #"
                    .concat(n.attempt + 1, " in ")
                    .concat(d, "ms"),
                  e,
                ),
              (n.timeoutId = setTimeout(l, d)))
            : "resolved" === e.state()
              ? o.resolveWith(e, f)
              : o.rejectWith(e, f);
          return o;
    ...
    return (
      (s.abort = function () {
        ...
        for (var a = arguments.length, i = new Array(a), r = 0; r < a; r++)
          i[r] = arguments[r];
        (e.abort.apply(e, i),
          null === (t = n.jqXHR) || void 0 === t || t.abort.apply(t, i));
      }),
      s
    );
  }
  (T() &&
    a.default.ajaxPrefilter(function (e, t, a) {
      a.retry = function (t) {
        var i =
    ...
    T() &&
      ...
      a.default.ajaxTransport(function (e) {
        var t;
        if (e.crossDomain && e.async)
          return (
            e.timeout && ((e.xdrTimeout = e.timeout), delete e.timeout),
            {
              send: function (a, i) {
                function n(e, a, n, r) {
                  ((t.onload = t.onerror = t.ontimeout = function () {}),
                    (t = void 0),
                    i(e, a, n, r));
                }
  ...
  var P = T() && !!(window.File && window.FileList && window.FileReader),
    M = T() && !(!window.FormData || !P),
    E =
      T() &&
      (function () {
        var e;
        return (
          "draggable" in (e = document.createElement("div")) ||
    ...
    U = P && E,
    B = null,
    R = T() && /^[^(]+\(iP(?:hone|od|ad);\s*(.+?)\)/.exec(navigator.userAgent);
  if (R) {
    var V = /OS (\d*)_(\d*)/.exec(R[1]);
    V && (B = +V[1] + V[2] / 10);
  }
  var L =
      T() &&
    ...
    q = !1;
  try {
    T() && new window.Blob() && (q = window.Blob);
  } catch (e) {}
  var N = T() && (window.URL || window.webkitURL || !1),
    K = N && N.createObjectURL && N,
    H =
      T() &&
    ...
    G = function (e) {
      var t, a, i, n;
      for (n = [], a = 0, i = e.length; a < i; a++)
        ((t = e[a]), W.call(n, t) < 0 && n.push(t));
      return n;
    },
    X = function (e) {
    ...
    J = function (e) {
      ...
      return (
        ...
        (a = null),
        function () {
          return (t || ((a = e.apply(this, arguments)), (t = !0)), a);
        }
      );
    },
    Z = function (e) {
      return a.default.Deferred().resolve(e).promise();
    },
    Q = function (e, t, i, n) {
      var r, o;
      return (
        ...
        e.then(r(t, o.resolve), r(i, o.reject), r(n, o.notify)),
        o.promise()
      );
    },
    $ = function (e, t) {
    ...
    re = new RegExp("".concat(ne.source, "~[0-9]+"), "i"),
    oe = new RegExp(
      "^/?(".concat(ne.source, ")(?:/(-/(?:[^/]+/)+)?([^/]*))?$"),
      "i",
    ),
    ...
    ce = function (e) {
      var t;
      return (
        "http:" !== (t = document.location.protocol) && (t = "https:"),
        e.replace(/^\/\//, t + "//").replace(/\/+$/, "")
      );
    },
    de = function (e, t) {
      if (e.length > t) {
        var a = Math.ceil((t - 3) / 2),
          i = Math.floor((t - 3) / 2);
        return e.slice(0, a) + "..." + e.slice(-i);
      }
      return e;
    },
    pe = function (e, t, a) {
      var i, n;
      return e[0] > t[0] || e[1] > t[1] || a
        ? ((n = t[0] / e[0]),
          (i = t[1] / e[1]),
          !t[0] || (t[1] && n > i)
            ? [Math.round(i * e[0]), t[1]]
            : [t[0], Math.round(n * e[1])])
        : e.slice();
    },
    fe = function (e, t, i, n) {
      var r, o, l, s, u, c, d;
      if (
        ...
        (d = c === i[0] && o === i[1]) ||
          (l += "-/crop/"
            ...
            .concat(n.left, ",")
            .concat(n.top, "/")),
        (r = t.downscale && (c > s[0] || o > s[1])),
        (u = t.upscale && (c < s[0] || o < s[1])),
        r || u)
      ) {
        var p = y(s, 2);
        ((n.sw = p[0]),
          (n.sh = p[1]),
          (l += "-/resize/".concat(s.join("x"), "/")));
      } else d || (l += "-/preview/");
      return (
        ((e = a.default.extend({}, e)).cdnUrlModifiers = l),
        (e.cdnUrl = "".concat(e.originalUrl).concat(l || "")),
        (e.crop = n),
        e
      );
    },
    ...
    me = function (e, t, i) {
      ...
      return (
        (r = null),
        "" === (n = t.inputAcceptTypes) && (n = t.imagesOnly ? he : null),
        (o = function () {
          return (
            (r = (
              t.multiple
                ? a.default('<input type="file" multiple>')
                : a.default('<input type="file">')
            )
              .attr("accept", n)
              .css({
                position: "absolute",
              ...
              .on("change", function () {
                return (i(this), a.default(this).hide(), o());
              })),
            e.append(r)
          );
        })(),
        e
          ...
          .mousemove(function (e) {
            var t,
              i,
              n,
              o = a.default(this).offset();
            return (
              (t = o.left),
              (i = o.top),
              (n = r.width()),
              r.css({ left: e.pageX - t - n + 10, top: e.pageY - i - 10 })
            );
          })
      );
    },
    ge = function (e, t, i) {
      ...
      return (
        ...
        a
          .default(
            t.multiple ? '<input type="file" multiple>' : '<input type="file">',
          )
          .attr("accept", n)
          .attr(r)
          .css({ position: "fixed", bottom: 0, opacity: 0 })
          .on("change", function () {
            return (i(this), a.default(this).remove());
          })
          .appendTo(e)
          .focus()
          .click()
    ...
    _e = "B KB MB GB TB PB EB ZB YB".split(" "),
    ve = function (e) {
      var t,
        a,
        i,
      ...
      for (
        t = 2, i = 0, n = 1e3 - 5 * Math.pow(10, 2 - Math.max(t, 3));
        e > n && i < _e.length - 1;
      )
        (i++, (e /= 1024));
      return (
        (e += 1e-15),
        (a = Math.max(0, t - Math.floor(e).toFixed(0).length)),
        (e = Number(e.toFixed(a))),
        "".concat(o).concat(e, " ").concat(_e[i]).concat(l)
      );
    },
    be = { dataType: "json", crossDomain: !0, cache: !1 },
    ye = function (e, t, i) {
      var n =
          arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
        r = a.default
          .ajax(a.default.extend({ url: e, type: t, data: i }, n, be))
          .retry(n.retryConfig)
          .fail(function (t, a, i) {
            var n = "".concat(a, " (").concat(i, ")");
            C(
              "JSONP unexpected error: ".concat(n, " while loading ").concat(e),
            );
          }),
        o = r.then(function (e) {
          var t, i;
          return e.error
            ? ("string" == typeof e.error
                ? ((t = e.error), (i = e.error_code))
                : ((t = e.error.content), (i = e.error.error_code)),
              a.default.Deferred().reject({ message: t, code: i }))
            : e;
        });
      return ((o.abort = r.abort.bind(r)), o);
    },
    we = function (e, t, a, i) {
      var n, r, o, l, s, u;
      if (window.HTMLCanvasElement.prototype.toBlob) return e.toBlob(i, t, a);
      for (
        o = (o = e.toDataURL(t, a)).split(","),
          r = window.atob(o[1]),
        ...
        n[l] = r.charCodeAt(l);
      return i(new window.Blob([n], { type: /:(.+\/.+);/.exec(o[0])[1] }));
    },
    xe = function (e) {
      var t, a, i;
      return (
    ...
    ze = function (e) {
      ...
      return a.default
        .Deferred(function (t) {
          return a.default.each(ke, function (n, r) {
            var o;
            return (
              (o = a.default.isFunction(i[r[2]]) && i[r[2]]),
              e[r[1]](function () {
                var i;
                return (i = o && o.apply(this, arguments)) &&
                  a.default.isFunction(i.promise)
                  ? i
                      .promise()
                      .progress(t.notify)
                      .done(t.resolve)
    ...
    Ae = function (e) {
      ...
      return (
        (t = r(
          {},
          (t = e.metadataCallback
            ? e.metadataCallback() || {}
            : e.metadata || {}),
        )),
        a.default.each(t, function (e, a) {
          t[e] = String(a);
        }),
        t
      );
  ...
  function De(e, t) {
    try {
      ...
      o &&
        ((o.fillStyle = je),
        o.fillRect.apply(o, a),
        r.drawImage(n, e - 1, t - 1, 1, 1, 0, 0, 1, 1));
      var l = r && r.getImageData(0, 0, 1, 1).data,
        s = !1;
      return (
        l && (s = l[0] === Ce && l[1] === Se && l[2] === Fe && l[3] === Te),
        (n.width = n.height = 1),
        s
      );
    } catch (a) {
      return (
        z(
          "Failed to test for max canvas size of "
            .concat(e, "x")
            .concat(t, "."),
          a,
        ),
  ...
  function Ie(e, t) {
    ...
    return function () {
      for (var i = arguments.length, n = new Array(i), r = 0; r < i; r++)
        n[r] = arguments[r];
      var o = t(n, a);
      return o in a ? a[o] : (a[o] = e.apply(void 0, n));
    };
  }
  var Pe = {
      squareSide: [
        Math.floor(Math.sqrt(5e6)),
        4096,
        8192,
        11180,
        10836,
    ...
    Me = Pe.squareSide[Pe.squareSide.length - 1];
  function Ee(e) {
    return function () {
  ...
  function Re(e, t) {
    var i = a.default.Deferred(),
      n = Pe.squareSide.find(function (a) {
        return a * a >= e * t;
      }),
      r = Pe.dimension.find(function (a) {
        return a >= e && a >= t;
      });
    if (!n || !r) return i.reject();
    var o = [Ue(n, n), Be(r, 1)];
    return (
      a.default.when.apply(a.default, o).done(function (e, t) {
        e && t ? i.resolve() : i.reject();
      }),
      i.promise()
    );
  }
  ...
  ((Ke = {
    ...
    (He = r({}, Ke)),
    (nt = { multipleMax: { from: 0, to: 1e3 } }),
    (qe = { multipleMax: { min: 1, max: 1e3 } }),
    (et = {
      tabs: {
    ...
    (tt =
      ...
      (document.currentScript ||
        (st = document.getElementsByTagName("script"))[st.length - 1])),
    (Xe = T() && a.default(tt).data("integration")) &&
      null != Xe &&
      (Ke = a.default.extend(Ke, { integration: Xe })),
    (at = function (e) {
      return (
        a.default.isArray(e) ||
          (e = (e = a.default.trim(e)) ? e.split(" ") : []),
        e
      );
    }),
    (Ve = function (e, t) {
      ...
      for (a = 0, o = t.length; a < o; a++) {
        if (((r = t[a]), (u = s = at(e[r])), c.apply(et, [r])))
          for (u = [], n = 0, l = s.length; n < l; n++)
            ((i = s[n]),
              c.apply(et[r], [i]) ? (u = u.concat(at(et[r][i]))) : u.push(i));
        e[r] = G(u);
      }
      return e;
    }),
    ...
    (We = function (e, t) {
      ...
      for (i = 0, r = t.length; i < r; i++)
        null != e[(n = t[i])] &&
          ("string" == typeof (o = e[n])
            ? ((o = a.default.trim(o).toLowerCase()),
              (e[n] = !("false" === o || "disabled" === o)))
            : (e[n] = !!o));
      return e;
    }),
    (Ge = function (e, t) {
    ...
    (Je = function (e) {
      (e.retryAttempts === He.retryAttempts &&
        null !== e.multipartMaxAttempts &&
        (e.retryAttempts = e.multipartMaxAttempts),
        (e.retryConfig = {
          baseTimeout: e.retryBaseTimeout,
          factor: e.retryFactor,
          attempts: e.retryAttempts,
          debugUploads: e.debugUploads,
          throttledAttempts: e.retryThrottledAttempts,
        }));
    }),
    (it = function (e, t) {
      var a, i;
      for (a in t)
        ((i = t[a]), null != e[a] && e[a] === i.from && (e[a] = i.to));
      return e;
    }),
    (Le = function (e, t) {
      var a, i, n;
      for (a in t) {
        ...
        ((n = r.min),
          (i = r.max),
          null != e[a] && (e[a] = Math.min(Math.max(e[a], n), i)));
      }
      return e;
    }),
    (ot = function (e, t) {
      for (var a = 0, i = t.length; a < i; a++) {
        ...
        e[n] &&
          ...
          F(
            'Option "'
              .concat(n, '" is expected to be a function. Instead got: ')
              .concat(o(e[n])),
          );
      }
    }),
    (lt = function (e, t) {
      for (var a = 0, i = t.length; a < i; a++) {
        ...
        e[n] &&
          ...
          F(
            'Option "'
              .concat(n, '" is expected to be an object. Instead got: ')
              .concat(o(e[n])),
          );
      }
      var r;
    ...
    (Qe = function (e) {
      ...
      return {
        downscale:
          "x" ===
          (t =
            /^([0-9]+)([x:])([0-9]+)\s*(|upscale|minimum)$/i.exec(
              a.default.trim(e.toLowerCase()),
            ) || [])[2],
        upscale: !!t[4],
        notLess: "minimum" === t[4],
        preferedSize: t.length ? [+t[1], +t[3]] : void 0,
      };
    }),
    ($e = function (e) {
      var t =
        /^([0-9]+)x([0-9]+)(?:\s+(\d{1,2}|100)%)?$/i.exec(
          a.default.trim(e.toLowerCase()),
        ) || [];
      ...
      return i > n
        ? (F(
            "Shrinked size can not be larger than ".concat(
              Math.floor(n / 1e3 / 1e3),
              "MP. ",
            ) +
              "You have set ".concat(t[1], "x").concat(t[2], " (") +
              "".concat(Math.ceil(i / 1e3 / 100) / 10, "MP)."),
          ),
          !1)
        : { quality: t[3] ? t[3] / 100 : void 0, size: i };
    }),
    (Ne = function (e, t) {
      var a, i, n, r;
      return this.previewProxy
        ? ((i =
            (n = !/\?/.test(this.previewProxy)) ||
            !/=$/.test(this.previewProxy)),
          (a = !n && !/[&?=]$/.test(this.previewProxy)),
    ...
    (Ze = function (e) {
      (Ve(e, ["tabs", "preferredTypes", "videoPreferredMimeTypes"]),
        rt(e, ["cdnBase", "socialBase", "urlBase", "scriptBase"]),
        We(e, [
          "doNotStore",
          "imagesOnly",
          "multiple",
        ...
        Je(e),
        !1 === e.crop ||
          a.default.isArray(e.crop) ||
          (/^(disabled?|false|null)$/i.test(e.crop)
            ? (e.crop = !1)
            : a.default.isPlainObject(e.crop)
              ? (e.crop = [e.crop])
              : (e.crop = a.default.map(("" + e.crop).split(","), Qe))),
        e.imageShrink &&
          !a.default.isPlainObject(e.imageShrink) &&
          (e.imageShrink = $e(e.imageShrink)),
        (e.crop || e.multiple) && (e.previewStep = !0),
        M || (e.systemDialog = !1),
        e.validators && (e.validators = e.validators.slice()),
        e.previewProxy && !e.previewUrlCallback && (e.previewUrlCallback = Ne));
  ...
  var ct,
    dt = function () {
      var e, t, a;
      for (e in ((t = {}), Ke))
        null != (a = window["UPLOADCARE_".concat(ee(e))]) && (t[e] = a);
      return t;
    },
    pt = J(function (e, t) {
      var i;
      return (
        t || (Ke = a.default.extend(Ke, dt())),
        (i = Ze(a.default.extend(Ke, e || {}))),
        ht.fire(i),
        i
      );
    }),
    ft = function (e) {
      var t;
      return (
        (t = a.default.extend({}, pt())),
        a.default.isEmptyObject(e) || (t = Ze(a.default.extend(t, e))),
        t
      );
    },
    ht = T() && a.default.Callbacks("once memory"),
    mt = (function () {
      function e() {
        (s(this, e), (this.urls = []), (this.styles = []));
      }
      return (
        c(e, [
          {
            ...
            value: function (e) {
              if (!/^https?:\/\//i.test(e))
                throw new Error("Embedded urls should be absolute. " + e);
    ...
    gt = function (e, t) {
      ...
      return (
        ...
        e.complete
          ? i.resolve(e)
          : (a.default(e).one("load", function () {
              return i.resolve(e);
            }),
            a.default(e).one("error", function () {
              return i.reject(e);
            })),
        i.promise()
      );
    ...
    _t = function e(t) {
      return a.default.isArray(t)
        ? a.default.when.apply(null, a.default.map(t, e))
        : t.src
          ? gt(t)
          : gt(new window.Image(), t);
    },
    vt = function (e) {
    ...
    bt = function () {
      var e = a.default.Deferred();
      if (void 0 !== ct) e.resolve(ct);
      else {
        var t = new window.Image();
        ((t.onload = function () {
          ((ct = t.naturalWidth < t.naturalHeight),
            (t.src = "//:0"),
            e.resolve(ct));
        }),
          (t.src =
      ...
      return (
        X(function () {
          try {
            ...
            (z(
              "Failed to shrink image to size ".concat(t, "x").concat(i, "."),
              e,
            ),
              n.reject(e));
          }
    ...
    wt = function (e, t, i, n, r) {
      var o = (function (e, t, a, i) {
          var n = [],
            ...
            o = a;
          do {
            (n.push([r, o]), (r = Math.round(r / i)), (o = Math.round(o / i)));
          } while (r < e * i);
          return n.reverse();
        })(t, i, n, r),
        l = a.default.Deferred(),
      ...
      try {
        var d = function () {
          ...
          s = s
            ...
            .then(function (e) {
              return (l.notify((t - n) / (t - i)), e);
            });
        };
        for (c.s(); !(u = c.n()).done; ) d();
      } catch (e) {
        c.e(e);
      } finally {
        c.f();
    ...
    xt = function (e, t) {
      var i = a.default.Deferred();
      if (0.71 * e.width * e.height * 0.71 < t.size)
        return i.reject("not required");
      var n = e.width,
        r = e.height,
        o = n / r,
        l = Math.floor(Math.sqrt(t.size * o)),
        s = Math.floor(t.size / Math.sqrt(t.size * o));
      return (
        Re(l, s)
          .fail(function () {
            i.reject("not supported");
          })
          .then(function () {
            ...
            !L
              ...
              .fail(function () {
                return i.reject("not supported");
              });
          }),
        i.promise()
      );
    },
    kt = T() && window.DataView,
    zt = xe(1),
    At = function (e, t) {
      var i = a.default.Deferred();
      return K && kt && q
        ? (zt(function (n) {
            (i.always(n),
              Mt(e)
                .then(function (e) {
                  if (e)
                    return (i.reject("skipped"), a.default.Deferred().reject());
                })
                .then(function () {
                  return Pt(e).fail(function () {
                    i.reject("not image");
                  });
                })
                .done(function (n) {
                  ...
                  var r = a.default
                    .when(Tt(e), bt(), jt(e))
                    .always(function (e, o, l) {
                      i.notify(0.2);
                      var s = "resolved" === r.state(),
                        u = xt(n, t);
                      (u.progress(function (e) {
                        return i.notify(0.2 + 0.6 * e);
                      }),
                        u.fail(i.reject),
                        u.done(function (n) {
                          var r = "image/jpeg",
                            u = t.quality || 0.8;
                          (!s && Bt(n) && ((r = "image/png"), (u = void 0)),
                            we(n, r, u, function (t) {
                              ((n.width = n.height = 1), i.notify(0.9));
                              var r = a.default.Deferred().resolve(t);
                              (e &&
                                (r = r
                                  .then(function (t) {
                                    return Dt(t, e, o);
    ...
    Ct = function (e, t, i, n, r) {
      ...
      return (
        (o = a.default.Deferred()),
        K
          ? ((l = _t(K.createObjectURL(e))).always(function (e) {
              return K.revokeObjectURL(e.src);
            }),
            l.fail(function () {
              return o.reject("not image");
            }),
            l.done(function (l) {
              return (
                o.always(function () {
                ...
                r && l.width * l.height > r
                  ? o.reject("max source")
                  : a.default.when(Tt(e), bt()).always(function (e, a) {
                      var r = a ? 1 : Ot(e) || 1,
                        s = r > 4,
                        u = s ? [l.height, l.width] : [l.width, l.height],
                        c = y(pe(u, [t, i]), 2),
                        d = c[0],
                        p = c[1],
                        f = [
                      ...
                      if (!f) return o.reject("bad image");
                      var h = document.createElement("canvas");
                      ((h.width = d), (h.height = p));
                      var m = h.getContext("2d");
                      if ((m.transform.apply(m, f), s)) {
                        var g = [p, d];
                        ((d = g[0]), (p = g[1]));
                      }
                      return (
                        n && ((m.fillStyle = n), m.fillRect(0, 0, d, p)),
                        m.drawImage(l, 0, 0, d, p),
                        o.resolve(h, u)
                      );
                    })
              );
    ...
    St = function (e) {
      ...
      return (
        (o = function (e, a) {
          var i;
          return (
            ((i = new H()).onload = function () {
              return a(new kt(i.result));
            }),
        ...
        (n = function () {
          return o(e.slice(i, i + 128), function (e) {
            var t, a, n;
            for (
              t = a = 0, n = e.byteLength;
              n >= 0 ? a < n : a > n;
              t = n >= 0 ? ++a : --a
            )
              if (255 === e.getUint8(t)) {
        ...
        (r = function () {
          ...
          return (
            (a = i),
            o(e.slice(i, (i += 4)), function (r) {
              var l, s;
              return 4 !== r.byteLength || 255 !== r.getUint8(0)
                ? t.reject("corrupted")
                : 218 === (s = r.getUint8(1))
                  ? t.resolve()
                  : ((l = r.getUint16(2) - 2),
                    o(e.slice(i, (i += l)), function (e) {
                      return e.byteLength !== l
                        ? t.reject("corrupted")
                        : (t.notify(a, l, s, e), n());
                    }));
            })
        ...
        (t = a.default.Deferred()),
        H && kt
          ? ((i = 2),
            o(e.slice(0, 2), function (e) {
              return 65496 !== e.getUint16(0) ? t.reject("not jpeg") : n();
            }),
            t.promise())
          : t.reject("support")
      );
    ...
    Ft = function (e, t, i) {
      var n, r, o, l;
      return (
        (n = a.default.Deferred()),
        (o = []),
        (r = []),
        (l = St(e)).fail(n.reject),
        l.progress(function (e, a, i) {
          if (i === t) return (o.push(e), r.push(a));
        }),
        l.done(function () {
          var a, l, s, u, c, d, p, f, h;
          for (p = [e.slice(0, 2)], u = 0, d = i.length; u < d; u++)
            ((a = i[u]),
              (s = new kt(new ArrayBuffer(4))).setUint16(0, 65280 + t),
              s.setUint16(2, a.byteLength + 2),
              p.push(s.buffer),
              p.push(a));
          for (
            f = 2, l = c = 0, h = o.length;
            h >= 0 ? c < h : c > h;
            l = h >= 0 ? ++c : --c
          )
            (o[l] > f && p.push(e.slice(f, o[l])), (f = o[l] + r[l] + 4));
          return (
            p.push(e.slice(f, e.size)),
            n.resolve(new q(p, { type: e.type }))
          );
        }),
        n.promise()
      );
    ...
    Tt = function (e) {
      var t = null,
        i = St(e);
      return (
        i.progress(function (e, a, i, n) {
          if (
            !t &&
            225 === i &&
            n.byteLength >= 14 &&
            1165519206 === n.getUint32(0) &&
            0 === n.getUint16(4)
          )
            return (t = n);
        }),
        i.then(
          ...
          function () {
            return a.default.Deferred().reject(t);
          },
        )
      );
    },
    jt = function (e) {
      ...
      return (
        i.progress(function (e, a, i, n) {
          226 === i &&
            1229144927 === n.getUint32(0) &&
            1347571526 === n.getUint32(4) &&
            1229735168 === n.getUint32(8) &&
            t.push(n);
        }),
        i.then(
          function () {
    ...
    Dt = function (e, t, a) {
      return (a && Et(t, 1), Ft(e, 225, [t.buffer]));
    },
    It = function (e, t) {
      return Ft(
        e,
    ...
    Pt = function (e) {
      ...
      return (
        It(e, [])
          ...
          .then(function (e) {
            var a = _t(K.createObjectURL(e));
            (a.always(function (e) {
              K.revokeObjectURL(e.src);
            }),
              a.fail(function () {
                t.reject();
              }),
    ...
    Mt = function (e) {
      var t = [1, 3],
        a = [192, 193, 194, 195, 197, 198, 199, 201, 202, 203, 205, 206, 207],
        i = !1,
        n = St(e);
      return (
        n.progress(function (e, n, r, o) {
          if (!i && a.indexOf(r) >= 0) {
            var l = o.getUint8(5);
            t.indexOf(l) < 0 && (i = !0);
          }
    ...
    Et = function (e, t) {
      Ut(e, function (a, i) {
        return e.setUint16(a, t, i);
      });
    },
    Ot = function (e) {
      return Ut(e, function (t, a) {
    ...
    Ut = function (e, t) {
      ...
      for (
        n = 8 + e.getUint32(10, i), a = 0, r = e.getUint16(n - 2, i);
        r >= 0 ? a < r : a > r;
        r >= 0 ? ++a : --a
      ) {
        if (e.byteLength < n + 10) return null;
        if (274 === e.getUint16(n, i)) return t(n + 8, i);
        n += 12;
      }
      return null;
    },
    Bt = function (e) {
      ...
      for (
        50,
          (t = document.createElement("canvas")).width = t.height = 50,
          (a = t.getContext("2d")).drawImage(e, 0, 0, 50, 50),
          i = a.getImageData(0, 0, 50, 50).data,
          t.width = t.height = 1,
          n = r = 3,
          o = i.length;
        r < o;
        ...
        c(e, [
          {
            key: "__startUpload",
            value: function () {
              return a.default.Deferred().resolve();
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                (i = 100),
                (e = function () {
                  if ("pending" === n.apiDeferred.state())
                    return (
                      (a += 1),
                      n.__updateInfo().done(function () {
            ...
            value: function () {
              ...
              return ye(
                ...
                "GET",
                {
                  ...
                  wait_is_ready: +(null === this.isImage),
                },
                {
          ...
          },
          {
            ...
            value: function (e) {
              if (
                ...
                e.default_effects &&
                  (this.cdnUrlModifiers = "-/" + e.default_effects),
                this.s3Bucket &&
                  this.cdnUrlModifiers &&
          ...
          },
          {
            ...
            value: function () {
              ...
              return {
                ...
                progress:
                  "ready" === (e = this.__progressState) || "error" === e
                    ? 1
                    : 0.9 * this.__progress,
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                (e = this.s3Bucket
                  ? "https://"
                      .concat(this.s3Bucket, ".s3.amazonaws.com/")
                      .concat(this.fileId, "/")
                      .concat(this.sanitizedName)
                  : ""
                      .concat(this.settings.cdnBase, "/")
                      .concat(this.fileId, "/")),
                {
                  uuid: this.fileId,
                  name: this.fileName,
                  ...
                  cdnUrl: this.fileId
                    ? "".concat(e).concat(this.cdnUrlModifiers || "")
                    : null,
          ...
          },
          {
            ...
            value: function () {
              ...
              try {
                for (
                  n = this.validators, r = [], t = 0, i = n.length;
                  t < i;
                  t++
                )
                  ((o = n[t]), r.push(o(a)));
          ...
          },
          {
            ...
            value: function () {
              return (
                (this.apiDeferred = a.default.Deferred()),
          ...
          },
          {
            ...
            value: function (e, t) {
              return (
                ...
                this.__notifyApi(),
                this.apiDeferred.reject(e, this.__fileInfo(), t)
              );
            },
          },
          {
            ...
            value: function () {
              return (
                ...
                this.__notifyApi(),
                this.apiDeferred.resolve(this.__fileInfo())
              );
            },
          },
          {
                ...
                (e.pipe = e.then =
                  function () {
                    for (
                      ...
                      i[n] = arguments[n];
                    return t.__extendApi(ze.apply(void 0, [e].concat(i)));
                  }),
                e
              );
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                this.__apiPromise ||
                  ((this.__apiPromise = this.__extendApi(
                    this.apiDeferred.promise(),
                  )),
                  this.__runValidators(),
                  "pending" === this.apiDeferred.state() &&
                    ((e = this.__startUpload()).done(function () {
                      return (
                        (t.__progressState = "uploaded"),
                        (t.__progress = 1),
                        t.__notifyApi(),
                        t.__completeUpload()
                      );
                    ...
                    e.progress(function (e) {
                      if (e > t.__progress)
                        return ((t.__progress = e), t.__notifyApi());
                    }),
                    e.fail(function (e) {
    ...
    Lt = (function (e) {
      ...
      function i(e) {
        ...
        return (
          s(this, i),
          ((a = t.apply(this, arguments)).__file = e),
          (a.fileName = a.__file.name || "original"),
          a.__notifyApi(),
          a
        );
      }
      return (
        c(i, [
            ...
            value: function (e) {
              if (
                ...
                return (
                  ...
                  (this.fileType =
                    this.__file.type || "application/octet-stream"),
                  this.settings.debugUploads &&
                    A(
                      "Use local file.",
                      this.fileName,
            ...
            value: function () {
              ...
              return (
                this.apiDeferred.always(function () {
                  return ((n.__file = null), n.__file);
                }),
                this.__file.size >= this.settings.multipartMinSize && q
                  ? (this.setFile(), this.multipartUpload())
                  : ((t = B),
                    !this.settings.imageShrink || (t && t < 8)
                      ? (this.setFile(), this.directUpload())
                      : ((e = a.default.Deferred()),
                        (i = 0.4),
          ...
          },
          {
            ...
            value: function (e) {
              return (
                Vt || (Vt = xe(this.settings.parallelDirectUploads)),
                Vt(e)
              );
            },
          },
              ...
              return (
                ...
                this.__file
                  ? this.fileSize > 104857600
                    ...
                    : (this.directRunner(function (i) {
                        if (
                          (e.always(i), "pending" === t.apiDeferred.state())
                        ) {
                          ...
                          return (
                            ...
                            n.append("signature", t.settings.secureSignature),
                            n.append("expire", t.settings.secureExpire),
                            n.append(
                              "UPLOADCARE_STORE",
                              t.settings.doNotStore ? "" : "auto",
                            ),
                            n.append("file", t.__file, t.fileName),
                            n.append("file_name", t.fileName),
                            n.append("source", t.sourceInfo.source),
                            a.default.each(Ae(t.settings), function (e, t) {
                              n.append("metadata[".concat(e, "]"), t);
                            }),
                            t.__autoAbort(
                              a.default
                                .ajax({
                                  ...
                                  headers: {
                                    "X-UC-User-Agent": t.settings._userAgent,
                                  },
                                  contentType: !1,
                                  processData: !1,
                                  data: n,
                                ...
                                .done(function (a) {
                                  if (null != a ? a.file : void 0)
                                    return ((t.fileId = a.file), e.resolve());
                                  if (a.error) {
                                    var i = a.error,
                                      n = i.content,
                                      r = i.error_code;
                                    return e.reject({ message: n, code: r });
                                  }
                                  return e.reject();
                                })
                                .fail(e.reject),
              ...
              return (
                ...
                this.__file
                  ? (this.multipartStart()
                      .done(function (a) {
                        return t
                          .uploadParts(a.parts, a.uuid)
                          .done(function () {
                            return t
                              .multipartComplete(a.uuid)
                              .done(function (a) {
                                return (
                                  (t.fileId = a.uuid),
                                  t.__handleFileData(a),
                                  e.resolve()
                                );
                              })
                              .fail(e.reject);
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                a.default.each(Ae(this.settings), function (e, a) {
                  t["metadata[".concat(e, "]")] = a;
                }),
                this.__autoAbort(
                  ye(
                    "".concat(
                      this.settings.urlBase,
                      "/multipart/start/?jsonerrors=1",
                    ),
                    "POST",
                    t,
                    {
                  ...
                  if (e.settings.debugUploads)
                    return z("Can't start multipart upload.", a.message, t);
                })
              );
            },
          },
            ...
            value: function (e, t) {
              ...
              for (
                s = [],
                  ...
                  f = function (e, t) {
                    var a, n, r;
                    if (((s[e] = t), !(Date.now() - l < 250))) {
                      for (
                        l = Date.now(), r = 0, a = 0, n = s.length;
                        a < n;
                        a++
                      )
                        r += t = s[a];
                      return i.notify(r / h.fileSize);
                    }
                  },
                  i = a.default.Deferred(),
                  n = 0,
                  ...
                  c = function () {
                    if (!(d >= h.fileSize)) {
                      var o = d + h.settings.multipartPartSize;
                      h.fileSize < o + h.settings.multipartMinLastPartSize &&
                        (o = h.fileSize);
                      var l = h.__file.slice(d, o);
                      d = o;
                      var u = p;
                      return (
                        (n += 1),
                        (p += 1),
                        (function () {
                          if ("pending" === h.apiDeferred.state())
                            return (
                              (s[u] = 0),
                              h.__autoAbort(
                                a.default
                                  .ajax({
                                    ...
                                    type: "PUT",
                                    processData: !1,
                                    contentType: h.fileType,
                                    data: l,
                                  })
                                  .retry(
                                    r(
                                      r({}, h.settings.retryConfig),
                                      {},
                                      {
                                        onAttemptFail: function (e) {
                                          var a = e.attempt;
                                          h.settings.debugUploads &&
                                            A(
                                              "Part #"
                                                .concat(u, "(")
                                                .concat(
                  ...
                  o = 0,
                  u = this.settings.multipartConcurrency;
                u >= 0 ? o < u : o > u;
                u >= 0 ? ++o : --o
              )
                c();
              ...
              return (
                ...
                this.__autoAbort(
                  ye(
                    "".concat(
                      this.settings.urlBase,
                      "/multipart/complete/?jsonerrors=1",
                    ),
                    "POST",
                    t,
                    {
                  ...
                  if (a.settings.debugUploads)
                    return z(
                      "Can't complete multipart upload.",
                      e,
                      a.settings.publicKey,
                      t.message,
                    );
                })
              );
  ...
  var qt = (function (e) {
    ...
    function i(e) {
      ...
      return (
        s(this, i),
        ((n = t.apply(this, arguments)).__input = e),
        (n.fileId = ae()),
        (n.fileName = a.default(n.__input).val().split("\\").pop()),
        n.__notifyApi(),
        n
      );
    }
      ...
      c(i, [
        {
          ...
          value: function () {
            ...
            return (
              (e = a.default.Deferred()),
              (n = "".concat(this.settings.urlBase, "/iframe/")),
              (i = "uploadcare--iframe-".concat(this.fileId)),
              (this.__iframe = a
                .default("<iframe>")
                .attr({ id: i, name: i })
                .css("display", "none")
              ...
              a.default(this.__input).attr("name", "file"),
              (this.__iframeForm = a
                .default("<form>")
                .attr({
                  method: "POST",
                ...
                .append(
                  t("UPLOADCARE_SIGNATURE", this.settings.secureSignature),
                )
                .append(t("UPLOADCARE_EXPIRE", this.settings.secureExpire))
                .append(t("UPLOADCARE_FILE_ID", this.fileId))
                .append(
                  t("UPLOADCARE_STORE", this.settings.doNotStore ? "" : "auto"),
                )
        ...
        },
        {
          ...
          value: function () {
            var e, t;
            return (
              null != (e = this.__iframe) && e.off("load error").remove(),
              null != (t = this.__iframeForm) && t.remove(),
              (this.__iframe = null),
  ...
  qt.prototype.sourceName = "local-compat";
  var Nt = (function (e, t) {
      ...
      (function () {
        ...
        (((e = function (t, a) {
          ...
          (this.checkAppKey(),
            ...
            this.connection
              ...
              .bind("message", function (e) {
                var t,
                  a = 0 === e.event.indexOf("pusher_internal:");
                (e.channel &&
                  (t = i.channel(e.channel)) &&
                  t.emit(e.event, e.data),
                  a || i.global_emitter.emit(e.event, e.data));
              })
          ...
          (e.prototype = {
              ...
              return (
                "connected" === this.connection.state &&
                  a.authorize(
                    ...
                    function (i, n) {
                      i
                        ? a.emit("pusher:subscription_error", n)
                        : t.send_event("pusher:subscribe", {
                            channel: e,
                            auth: n.auth,
            ...
            unsubscribe: function (e) {
              (this.channels.remove(e),
                "connected" === this.connection.state &&
                  this.send_event("pusher:unsubscribe", { channel: e }));
            },
            send_event: function (e, t, a) {
              return this.connection.send_event(e, t, a);
            },
            checkAppKey: function () {
              (null !== this.key && void 0 !== this.key) ||
                e.warn(
                  "Warning",
            ...
            stringify: function () {
              for (var e = ["Pusher"], t = 0; t < arguments.length; t++)
                "string" == typeof arguments[t]
                  ? e.push(arguments[t])
                  : null == window.JSON
                    ? e.push(arguments[t].toString())
                    : e.push(JSON.stringify(arguments[t]));
              return e.join(" : ");
            },
          ...
          (e.warn = function () {
            if (window.console && window.console.warn)
              window.console.warn(e.Util.stringify.apply(this, arguments));
            else {
              if (!e.log) return;
          ...
          (e.ready = function () {
            e.isReady = !0;
            for (var t = 0, a = e.instances.length; t < a; t++)
          ...
          (function () {
            ...
            ((t.prototype.get = function (e) {
              ...
              (t.prototype.add = function (e, t) {
                var a = this._prefix(e);
                ((this._callbacks[a] = this._callbacks[a] || []),
                  this._callbacks[a].push(t));
              }),
              (t.prototype.remove = function (t, a) {
                if (this.get(t)) {
                  var i = e.Util.arrayIndexOf(this.get(t), a);
              ...
              (a.prototype.emit = function (e, t) {
                ...
                if (i) for (a = 0; a < i.length; a++) i[a](t);
                else this.failThrough && this.failThrough(e, t);
                return this;
              }),
              (a.prototype.bind_all = function (e) {
                return (this.global_callbacks.push(e), this);
              }),
              (e.EventsDispatcher = a));
          })(),
          (function () {
            function t(e, t, a) {
              void 0 !== t[e] && t[e](a);
            ...
            ((a.prototype.transition = function (a, i) {
              var n,
                r = this.state,
                o = this.stateActions;
              if (r && -1 == e.Util.arrayIndexOf(this.transitions[r], a))
                throw (
                  this.emit("invalid_transition_attempt", {
                    oldState: r,
                    newState: a,
                  }),
                  new Error("Invalid transition [" + r + " to " + a + "]")
                );
              (t(r + "Exit", o, i),
                t(
                  r + "To" + ((n = a).substr(0, 1).toUpperCase() + n.substr(1)),
                  o,
                  i,
                ),
                t(a + "Pre", o, i),
                (this.state = a),
                this.emit("state_change", { oldState: r, newState: a }),
                t(a + "Post", o, i));
            }),
              (a.prototype.is = function (e) {
                return this.state === e;
              }),
              (a.prototype.isNot = function (e) {
                return this.state !== e;
              }),
              e.Util.extend(a.prototype, e.EventsDispatcher.prototype),
              (e.Machine = a));
          })(),
          ((t = function () {
            var t = this;
          ...
          (function () {
            ...
            function a(t) {
              ((t.connectionWait = 0),
                "flash" === e.TransportType
                  ? (t.openTimeout = 5e3)
                  : (t.openTimeout = 2e3),
                (t.connectedTimeout = 2e3),
                (t.connectionSecure = t.compulsorySecure),
                (t.connectionAttempts = 0));
            }
            function i(i, n) {
              var r = this;
              function o() {
                (r.connectionWait < 1e4 && (r.connectionWait += 2e3),
                  ...
                  !0 !== r.compulsorySecure &&
                    (r.connectionSecure = !r.connectionSecure),
                ...
                void 0 !== i &&
                  ("pusher:connection_established" === i.event
                    ...
                    : "pusher:error" === i.event &&
                      ...
                      r.emit("error", {
                        type: "PusherError",
                        data: { code: t, message: a },
                      }),
                      4e3 === t
                        ? ((r.compulsorySecure = !0),
                          (r.connectionSecure = !0),
                          (r.options.encrypted = !0),
                          l())
                        : t < 4100
                          ? r._machine.transition("permanentlyClosing")
                          : t < 4200
                            ? ((r.connectionWait = 1e3),
              ...
              function d(t) {
                ...
                var a = p(t);
                if (void 0 !== a) {
                  switch ((e.debug("Event recd", a), a.event)) {
                    case "pusher:error":
                      r.emit("error", { type: "PusherError", data: a.data });
                      break;
                    case "pusher:ping":
              ...
              function m(t, a) {
                ...
                ((r.state = t),
                  i !== t &&
                    (e.debug("State changed", i + " -> " + t),
                    r.emit("state_change", { previous: i, current: t }),
                    r.emit(t, a)));
              }
              (e.EventsDispatcher.call(this),
                (this.options = e.Util.extend({ encrypted: !1 }, n)),
                (this.netInfo = new e.NetInfo()),
                this.netInfo.bind("online", function () {
                  r._machine.is("waiting") &&
                    (r._machine.transition("connecting"), m("connecting"));
                }),
                this.netInfo.bind("offline", function () {
                  r._machine.is("connected") &&
                    ((r.socket.onclose = void 0),
                    (r.socket.onmessage = void 0),
                    (r.socket.onerror = void 0),
                    (r.socket.onopen = void 0),
                    r.socket.close(),
                    (r.socket = void 0),
                    r._machine.transition("waiting"));
                }),
                (this._machine = new e.Machine("initialized", t, {
                  initializedPre: function () {
                    ((r.compulsorySecure = r.options.encrypted),
                      (r.key = i),
                      (r.socket = null),
                      (r.socket_id = null),
                      (r.state = "initialized"));
                  ...
                  waitingPre: function () {
                    (r.connectionWait > 0 &&
                      r.emit("connecting_in", r.connectionWait),
                      r.netInfo.isOnLine() && r.connectionAttempts <= 4
                        ? m("connecting")
                        : m("unavailable"),
                      r.netInfo.isOnLine() &&
                  ...
                  connectingPre: function () {
                    ...
                    var t = (function (t, a) {
                      ...
                      return (
                        ...
                        "/app/" +
                        t +
                        "?protocol=5&client=js&version=" +
                        e.VERSION +
                        "&flash=" +
                        r
                      );
                    })(r.key, r.connectionSecure);
                    (e.debug("Connecting", t),
                      (r.socket = new e.Transport(t)),
                      (r.socket.onopen = u),
                      (r.socket.onclose = f),
                      (r.socket.onerror = h),
                      (r._connectingTimer = setTimeout(l, r.openTimeout)));
                  },
                  connectingExit: function () {
                    (clearTimeout(r._connectingTimer),
                      (r.socket.onopen = void 0));
                  },
                  ...
                  openPre: function () {
                    ((r.socket.onmessage = c),
                      (r.socket.onerror = h),
                      (r.socket.onclose = f),
                      (r._openTimer = setTimeout(l, r.connectedTimeout)));
                  },
                  openExit: function () {
                  ...
                  connectedPre: function (e) {
                    ((r.socket_id = e),
                      (r.socket.onmessage = d),
                      (r.socket.onerror = h),
                      (r.socket.onclose = f),
                      a(r),
                      (r.connectedAt = new Date().getTime()),
                      s());
                  },
                  ...
                  failedPre: function () {
                    (m("failed"),
                      e.debug("WebSockets are not available in this browser."));
                  },
            ...
            ((i.prototype.connect = function () {
              this._machine.is("failed") || e.Transport
                ? this._machine.is("initialized")
                  ? (a(this), this._machine.transition("waiting"))
                  : this._machine.is("waiting") &&
                      !0 === this.netInfo.isOnLine()
                    ? this._machine.transition("connecting")
                    : this._machine.is("permanentlyClosed") &&
                      (a(this), this._machine.transition("waiting"))
              ...
              (i.prototype.send_event = function (t, a, i) {
                var n = { event: t, data: a };
                return (
                  i && (n.channel = i),
                  e.debug("Event sent", n),
                  this.send(JSON.stringify(n))
                );
              }),
              (i.prototype.disconnect = function () {
                this._machine.is("permanentlyClosed") ||
                  (this._machine.is("waiting") || this._machine.is("failed")
          ...
          (function () {
            ((e.Channels = function () {
              ...
              (e.Channel = function (t, a) {
                var i = this;
                (e.EventsDispatcher.call(this, function (a, i) {
                  e.debug("No callbacks on " + t + " for " + a);
                }),
                  (this.pusher = a),
                  (this.name = t),
                  (this.subscribed = !1),
              ...
              (e.Channel.PrivateChannel = {
                authorize: function (t, a, i) {
                  var n = this;
                  return new e.Channel.Authorizer(
                    this,
                    e.channel_auth_transport,
                    a,
                  ).authorize(t, function (e, t) {
                    (e || n.emit("pusher_internal:authorized", t), i(e, t));
                  });
                },
              }),
            ...
            var t = function (e) {
              ...
              (a.call(this),
                e.bind("pusher_internal:authorized", function (a) {
                  var i = JSON.parse(a.channel_data);
                  e.bind(
                    "pusher_internal:subscription_succeeded",
                    function (a) {
                      ((t._members_map = a.presence.hash),
                        (t.count = a.presence.count),
                        (t.me = t.get(i.user_id)),
                        e.emit("pusher:subscription_succeeded", t));
                    },
                  );
                }),
                e.bind("pusher_internal:member_added", function (a) {
                  (null === t.get(a.user_id) && t.count++,
                    (t._members_map[a.user_id] = a.user_info),
                    e.emit("pusher:member_added", t.get(a.user_id)));
                }),
                e.bind("pusher_internal:member_removed", function (a) {
                  var i = t.get(a.user_id);
                  i &&
                    (delete t._members_map[a.user_id],
                    t.count--,
                    e.emit("pusher:member_removed", i));
                }),
            ...
            ((t.prototype = {
              ...
              get: function (e) {
                return this._members_map.hasOwnProperty(e)
                  ? { id: e, info: this._members_map[e] }
                  : null;
              },
            }),
              (e.Channel.factory = function (t, a) {
                var i = new e.Channel(t, a);
                return (
                  0 === t.indexOf("private-")
                    ? e.Util.extend(i, e.Channel.PrivateChannel)
                    : 0 === t.indexOf("presence-") &&
                      (e.Util.extend(i, e.Channel.PrivateChannel),
                      e.Util.extend(i, e.Channel.PresenceChannel)),
                  i.init(),
                  i
                );
              }));
          })(),
          (e.Channel.Authorizer = function (e, t, a) {
            ((this.channel = e),
              (this.type = t),
          ...
          (e.Channel.Authorizer.prototype = {
            composeQuery: function (e) {
              ...
              for (var a in this.authOptions.params)
                t +=
                  "&" +
                  encodeURIComponent(a) +
                  "=" +
                  encodeURIComponent(this.authOptions.params[a]);
              return t;
            },
            authorize: function (t, a) {
              return e.authorizers[this.type].call(this, t, a);
            },
          }),
          (e.auth_callbacks = {}),
          (e.authorizers = {
            ajax: function (t, a) {
              ...
              this.authOptions.headers))
                i.setRequestHeader(n, this.authOptions.headers[n]);
              return (
                  ...
                  if (4 == i.readyState)
                    if (200 == i.status) {
                      var t,
                        n = !1;
                      try {
                        ((t = JSON.parse(i.responseText)), (n = !0));
                      } catch (e) {
                        a(
                          !0,
                      ...
                      (e.warn(
                        "Couldn't get auth info from your webapp",
                        i.status,
                      ),
                        a(!0, i.status));
                }),
        ...
        (!(function () {
          (a() &&
            ...
            a() &&
              window.WebSocket &&
              ((e.Transport = window.WebSocket), (e.TransportType = "native")));
          var t =
              (a() &&
                ("http:" == document.location.protocol
                  ? e.cdn_http
                  : e.cdn_https)) + e.VERSION,
            i = [];
          (a() &&
            !window.JSON &&
            i.push(t + "/json2" + e.dependency_suffix + ".js"),
            a() &&
              !window.WebSocket &&
              ((window.WEB_SOCKET_DISABLE_AUTO_INITIALIZATION = !0),
              i.push(t + "/flashfallback" + e.dependency_suffix + ".js")));
          var r =
              a() && window.WebSocket
                ? function () {
                    e.ready();
                    ...
                    window.WebSocket
                      ? ((e.Transport = window.WebSocket),
                        ...
                        (window.WEB_SOCKET_SWF_LOCATION =
                          "https://s3.amazonaws.com/uploadcare-static/WebSocketMainInsecure.swf"),
                        WebSocket.__addTask(function () {
                          e.ready();
                        }),
                        WebSocket.__initialize())
                      : ((e.Transport = null),
                        (e.TransportType = "none"),
                        e.ready());
                  },
            o = function () {
              var e;
              ((e = r),
                (function t() {
                  a() && (document.body ? e() : setTimeout(t, 0));
                })());
            };
          i.length > 0 ? n(i, o) : o();
        })(),
  ...
  var Ht = (function (e) {
      ...
      var t = _(i);
      function i() {
        return (s(this, i), t.apply(this, arguments));
      }
      return (
        c(i, [
          {
            ...
            value: function (e) {
              return (
                ...
                this.connect(),
                b(f(i.prototype), "subscribe", this).apply(this, arguments)
              );
            },
          },
          {
            ...
            value: function (e) {
              var t = this;
              (b(f(i.prototype), "unsubscribe", this).apply(this, arguments),
                a.default.isEmptyObject(this.channels.channels) &&
    ...
    Wt = function (e) {
      return (null == Kt[e] && (Kt[e] = new Ht(e)), Kt[e].connect(), Kt[e]);
    },
    Gt = (function (e) {
      p(i, e);
      var t = _(i);
      function i(e) {
        ...
        if (
          (s(this, i),
          ((a = t.apply(this, arguments)).__url = e),
          (n = ie.exec(a.__url)[3].split("/").pop()))
        )
          try {
            a.fileName = decodeURIComponent(n);
          } catch (e) {
            a.fileName = n;
          }
        return (a.__notifyApi(), a);
      }
      return (
        c(i, [
          {
          ...
          },
          {
            ...
            value: function () {
              var e = this,
                t = a.default.Deferred(),
                i = new Xt(this.settings),
                n = new Yt(this.settings),
                r = {
                  pub_key: this.settings.publicKey,
                  signature: this.settings.secureSignature,
                  expire: this.settings.secureExpire,
              ...
              return (
                a.default.each(Ae(this.settings), function (e, t) {
                  r["metadata[".concat(e, "]")] = t;
                }),
                X(function () {
                  if ("pending" === e.apiDeferred.state())
                    return ye(
                      "".concat(e.settings.urlBase, "/from_url/"),
                      "GET",
                      r,
                      {
                        headers: { "X-UC-User-Agent": e.settings._userAgent },
                        retryConfig: e.settings.retryConfig,
                      },
                    )
                      .fail(function (a) {
                        return (
                          e.settings.debugUploads &&
                            A("Can't start upload from URL.", a.message, r),
                          t.reject(a)
                        );
                      })
                      .done(function (r) {
                        ...
                        if ("pending" === e.apiDeferred.state())
                          return (
                            ...
                            e.__listenWatcher(t, a.default([i, n])),
                            t.always(function () {
                              return (
                                a.default([i, n]).off(e.allEvents),
                                i.stopWatching(),
                                n.stopWatching()
                              );
                            }),
                            a.default(i).one(e.allEvents, function () {
                              if (n.interval)
                                return (
                                  e.settings.debugUploads &&
                                    A("Start using pusher.", r.token),
                                  n.stopWatching()
                                );
                            }),
                            i.watch(r.token),
          ...
          },
          {
            ...
            value: function (e, t) {
              var i = this;
              return t
                .on("progress", function (t, a) {
                  return ((i.fileSize = a.total), e.notify(a.done / a.total));
                })
                .on("success", function (t, n) {
                  return (
                    a.default(t.target).trigger("progress", n),
                    (i.fileId = n.uuid),
                    i.__handleFileData(n),
                    e.resolve()
                  );
                })
                .on("error fail", function (t, a) {
                  if (a.error_code) {
                    var i = a.error_code,
                      n = a.msg;
                    e.reject({ code: i, message: n });
                  } else e.reject(a);
                });
            },
          },
  ...
  ((Gt.prototype.sourceName = "url"),
    (Gt.prototype.allEvents = "progress success error fail"));
  var Xt = (function () {
      function e(t) {
        (s(this, e), (this.settings = t));
        try {
          this.pusher = Wt(this.settings.pusherKey);
        } catch (e) {
          this.pusher = null;
        }
      }
        ...
        c(e, [
          {
            ...
            value: function (e) {
              ...
              if (((this.token = e), this.pusher))
                return this.pusher
                  .subscribe("task-status-".concat(this.token))
                  .bind_all(function (e, i) {
                    return a.default(t).trigger(e, i);
                  });
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              return ye(
                ...
                .fail(function (t) {
                  return a.default(e).trigger("error", t);
                })
                .done(function (t) {
                  return a.default(e).trigger(t.status, t);
                });
            },
          },
        ]),
    ...
    Jt = (function (e) {
      ...
      function a(e) {
        ...
        return (
          ...
          (n = le(e))
            ? ((i.fileId = n[1]), n[2] && (i.cdnUrlModifiers = n[2]))
            : i.__rejectApi("baddata"),
          i
        );
      }
      return c(a);
  ...
  var Zt = (function (e) {
    ...
    function a(e) {
      ...
      return (
        ...
        (i = t.apply(this, arguments)),
        e
          ? ((i.fileId = e.uuid), i.__handleFileData(e))
          : i.__rejectApi("deleted"),
        i
      );
    }
    return c(a);
  })(Rt);
  Zt.prototype.sourceName = "uploaded";
  var Qt = { object: Lt, input: qt, url: Gt, uploaded: Jt, ready: Zt },
    $t = function (e, t, a) {
      return ea(e, [t], a)[0];
    },
    ea = function (e, t, i) {
      var n, r, o, l, s;
      for (i = ft(i || {}), s = [], n = 0, o = t.length; n < o; n++)
        ((l = t[n]),
          (r = void 0),
          a.default.isArray(l) && ((r = l[1]), (l = l[0])),
          s.push(new Qt[e](l, i, r).promise()));
      return s;
    },
    ta = function (e) {
    ...
    aa = function (e, t) {
      return (e && !ta(e) && (e = $t("uploaded", e, t)), e || null);
    },
    ia = function (e) {
    ...
    na = function (e, t) {
      ...
      if (e)
        if (a.default.isArray(e))
          ((i = (function () {
            var a, i, r;
            for (r = [], a = 0, i = e.length; a < i; a++)
              ((n = e[a]), r.push(aa(n, t)));
            return r;
          })()),
            (e = va(i, t)));
        else if (!ia(e)) return ba(e, t);
      return Z(e || null);
    },
    ra = function (e, t) {
      var a, i, n, r, o;
      ...
      if (((a = e.files()), (i = t.files()), a.length !== i.length)) return !1;
      for (n = r = 0, o = a.length; r < o; n = ++r)
        if (a[n] !== i[n]) return !1;
      return !0;
    },
    oa = [].indexOf,
    la = (function () {
      function e() {
        ...
        (s(this, e),
          (this.onAdd = a.default.Callbacks()),
          (this.onRemove = a.default.Callbacks()),
          (this.onSort = a.default.Callbacks()),
          (this.onReplace = a.default.Callbacks()),
          (this.__items = []),
          i || this.init(t));
      }
      return (
        c(e, [
          {
            ...
            value: function (e) {
              var t, a, i;
              for (a = 0, i = e.length; a < i; a++) ((t = e[a]), this.add(t));
            },
          },
          {
            key: "add",
          ...
          },
          {
            ...
            value: function (e) {
              var t;
              if (-1 !== (t = a.default.inArray(e, this.__items)))
                return this.__remove(e, t);
            },
          },
          {
            key: "__remove",
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                ...
                ((t = a[e]), r.push(this.onRemove.fire(t, e)));
              return r;
            },
          },
          {
            ...
            value: function (e, t) {
              var i;
              if (e !== t && -1 !== (i = a.default.inArray(e, this.__items)))
                return this.__replace(e, t, i);
            },
          },
          {
            key: "__replace",
            value: function (e, t, a) {
              return ((this.__items[a] = t), this.onReplace.fire(e, t, a));
            },
          },
          {
            key: "sort",
        ...
        c(a, [
          {
            key: "add",
            value: function (e) {
              if (!(oa.call(this.__items, e) >= 0))
                return b(f(a.prototype), "add", this).apply(this, arguments);
            },
          },
          {
            key: "__replace",
            value: function (e, t, i) {
              return oa.call(this.__items, t) >= 0
                ? this.remove(e)
                : b(f(a.prototype), "__replace", this).apply(this, arguments);
            },
          },
        ]),
        a
    ...
    ua = (function (e) {
      ...
      function i() {
        ...
        return (
          ...
          )).anyDoneList = a.default.Callbacks()),
          (n.anyFailList = a.default.Callbacks()),
          (n.anyProgressList = a.default.Callbacks()),
          (n._thenArgs = null),
          n.anyProgressList.add(function (e, t) {
            return a.default(e).data("lastProgress", t);
          }),
          b(((e = m(n)), f(i.prototype)), "init", e).call(e, arguments[0]),
          n
        );
      }
      return (
        c(i, [
          {
            ...
            value: function (e) {
              var t, a, i, n, r;
              for (
                this.anyDoneList.add(e),
                  r = [],
                  a = 0,
                  i = (n = this.__items).length;
                a < i;
                a++
              )
                "resolved" === (t = n[a]).state()
                  ? r.push(
                      t.done(function () {
                        for (
                          var a = arguments.length, i = new Array(a), n = 0;
          ...
          },
          {
            ...
            value: function (e) {
              var t, i, n, r, o;
              for (
                this.anyProgressList.add(e),
                  o = [],
                  i = 0,
                  n = (r = this.__items).length;
                i < n;
                i++
              )
                ((t = r[i]), o.push(e(t, a.default(t).data("lastProgress"))));
              return o;
            },
          },
          {
            ...
            value: function () {
              var e, t, i, n, r;
              for (r = [], t = 0, i = (n = this.__items).length; t < i; t++)
                ((e = n[t]), r.push(a.default(e).data("lastProgress")));
              return r;
            },
          },
          {
            ...
            value: function (e) {
              if (e && e.then) {
                var t;
                if (this._thenArgs)
                  e = (t = e).then.apply(t, w(this._thenArgs));
                return (
                  b(f(i.prototype), "add", this).call(this, e),
                  this.__watchItem(e)
                );
              }
            },
          },
          {
            ...
            value: function (e, t, a) {
              return t && t.then
                ? (b(f(i.prototype), "__replace", this).apply(this, arguments),
                  this.__watchItem(t))
                : this.remove(e);
            },
          },
                  ...
                  return function () {
                    if (oa.call(t.__items, e) >= 0) {
                      for (
                        ...
                        n[r] = arguments[r];
                      return a.fire.apply(a, [e].concat(n));
                    }
                  };
                };
              return e.then(
          ...
          },
          {
            ...
            value: function () {
              ...
              if (this._thenArgs)
                throw new Error(
                  "CollectionOfPromises.then() could be used only once",
                );
              for (
              ...
              for (
                ...
                ((t = n[e]),
                  r.push(
                    this.__replace(
                      t,
                      (u = t).then.apply(u, w(this._thenArgs)),
                      e,
                    ),
                  ));
              }
      ...
      ar: {
        translations: {
          ...
          buttons: {
            ...
            remove: "إزالة",
            choose: {
              files: { one: "اختر ملف", other: "اختر ملفات" },
              images: { one: "اختر صورة", other: "اختر صور" },
            },
          },
          dialog: {
            close: "أغلق",
      ...
      az: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Silin",
            choose: {
              files: { one: "Fayl seçin", other: "Fayllar seçin" },
              images: { one: "Təsvir seçin", other: "Təsvirlər seçin" },
            },
          },
          dialog: {
            done: "Hazırdır",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Həddindən çox fayl seçdiniz. %max% maksimumdur.",
                  tooFewFiles:
                    "%files% fayl seçdiniz. Ən azı %min% tələb olunur.",
      ...
      ca: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Eliminar",
            choose: {
              files: { one: "Escull un fitxer", other: "Escull fitxers" },
              images: { one: "Escull una imatge", other: "Escull imatges" },
            },
          },
          dialog: {
            done: "Fet",
            ...
            tabs: {
              ...
              preview: {
                ...
                unknown: {
                  title:
                    "Carregant. Si us plau esperi per la visualització prèvia.",
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Has escollit massa fitxers. %max% és el màxim.",
                  tooFewFiles:
                    "Has escollit %files%. Com a mínim en calen %min%.",
      ...
      cs: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Odstranit",
            choose: {
              files: { one: "Vyberte soubor", other: "Vyberte soubory" },
              images: { one: "Vyberte obrázek", other: "Vyberte obrázky" },
            },
          },
          dialog: {
            done: "Hotovo",
      ...
      da: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Fjern",
            choose: {
              files: { one: "Vælg en fil", other: "Vælg filer" },
              images: { one: "Vælg et billede", other: "Vælg billeder" },
            },
          },
          dialog: {
            done: "Færdig",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Du har valgt for mange filer. %max% er maximum.",
                  tooFewFiles:
      ...
      de: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Löschen",
            choose: {
              files: { one: "Datei auswählen", other: "Dateien auswählen" },
              images: { one: "Bild auswählen", other: "Bilder auswählen" },
            },
          },
          dialog: {
            close: "Schließen",
      ...
      el: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Κατάργηση",
            choose: {
              files: { one: "Επιλέξτε ένα αρχείο", other: "Επιλέξτε αρχεία" },
              images: { one: "Επιλέξτε μία εικόνα", other: "Επιλέξτε εικόνες" },
            },
          },
          dialog: {
            close: "Κλείσιμο",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooFewFiles:
                    "Έχετε επιλέξει %files%. Απαιτούνται τουλάχιστον %min%.",
      ...
      en: {
        ...
        translations: {
          ...
          buttons: {
            ...
            remove: "Remove",
            choose: {
              files: { one: "Choose a file", other: "Choose files" },
              images: { one: "Choose an image", other: "Choose images" },
            },
          },
          dialog: {
            close: "Close",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  question: "Add %files%?",
                  tooManyFiles:
                    "You’ve chosen too many files. %max% is maximum.",
                  tooFewFiles:
                    "You’ve chosen %files%. At least %min% required.",
                  clear: "Remove all",
                  done: "Add",
      ...
      es: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Eliminar",
            choose: {
              files: { one: "Escoge un archivo", other: "Escoge archivos" },
              images: { one: "Escoge una imagen", other: "Escoge imágenes" },
            },
          },
          dialog: {
            close: "Cerrar",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Has escogido demasiados archivos. %max% es el máximo.",
                  tooFewFiles:
                    "Has escogido %files%. Hacen falta al menos %min%.",
                  clear: "Eliminar todo",
                  done: "Hecho",
                  file: {
      ...
      et: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Kustuta",
            choose: {
              files: { one: "Vali fail", other: "Vali failid" },
              images: { one: "Vali pilt", other: "Vali pildid" },
            },
          },
          dialog: {
            done: "Valmis",
          ...
          dialog: {
            ...
            tabs: {
              ...
              preview: {
                ...
                unknown: {
                  title:
                    "Envoi en cours... Merci de patienter pour prévisualiser.",
                  done: "Passer la prévisualisation et accepter",
                },
                regular: {
                  title: "Ajouter ce fichier ?",
                  line1:
                    "Vous êtes sur le point d'ajouter le fichier ci-dessus.",
                ...
                multiple: {
                  ...
                  tooFewFiles:
                    "Vous avez choisi %fichiers%. %min% est le minimum.",
                  clear: "Tout retirer",
                  done: "Terminer",
                  file: {
      ...
      he: {
        translations: {
          ...
          buttons: {
            ...
            remove: "הסר",
            choose: {
              files: { one: "בחר קובץ", other: "בחר קבצים" },
              images: { one: "בחר תמונה", other: "בחר תמונות" },
            },
          },
          dialog: {
            done: "סיום",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "בחרת יותר מידי קבצים. יש לבחור מקסימום %max% קבצים.",
      ...
      is: {
        ...
        translations: {
          ...
          buttons: {
            ...
            remove: "Fjarlægja",
            choose: {
              files: { one: "Veldu skrá", other: "Veldu skrár" },
              images: { one: "Veldu mynd", other: "Veldu myndir" },
            },
          },
          dialog: {
            close: "Loka",
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  title:
                    "Vinsamlegast gefðu heimild til þess að nota myndavélina",
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Þú hefur valið of margar skrár. %max% er hámarkið.",
                  tooFewFiles:
      ...
      it: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Rimuovi",
            choose: {
              files: { one: "Seleziona un file", other: "Seleziona file" },
              images: {
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Hai selezionato troppi file. %max% è il massimo.",
                  tooFewFiles:
                    "Hai selezionato %files%. È richiesto almeno %min%.",
                  clear: "Rimuovi tutto",
                  done: "Fatto",
                },
              },
      ...
      ja: {
        translations: {
          ...
          buttons: {
            ...
            remove: "削除",
            choose: {
              files: { one: "ファイルを選択", other: "ファイルを選択" },
              images: { one: "画像を選択", other: "画像を選択" },
            },
          },
          dialog: {
            done: "完了",
      ...
      ko: {
        translations: {
          ...
          buttons: {
            ...
            remove: "삭제",
            choose: {
              files: { one: "파일 첨부", other: "파일 첨부" },
              images: { one: "이미지 첨부", other: "이미지 첨부" },
            },
          },
          dialog: {
            close: "닫기",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooFewFiles:
                    "%files%을(를) 선택하였습니다 최소 %min%이상 필요합니다",
                  clear: "모두 삭제",
                  done: "추가",
      ...
      nb: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Fjern",
            choose: {
              files: { one: "Velg en fil", other: "Velg filer" },
              images: { one: "Velg et bilde", other: "Velg bilder" },
            },
          },
          dialog: {
            done: "Ferdig",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Du har valgt for mange filer. %max% er maksimum.",
                  tooFewFiles:
                    "Du har valgt %files%. Minimum %min% er påkrevd.",
                  clear: "Fjern alle",
                  done: "Ferdig",
                },
              },
      ...
      nl: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Verwijderen",
            choose: {
              files: { one: "Kies een bestand", other: "Kies bestanden" },
              images: {
            ...
            tabs: {
              ...
              preview: {
                ...
                regular: {
                  ...
                  line1:
                    "Je staat op het punt bovenstaand bestand toe te voegen.",
                  line2: "Bevestig",
                },
                image: {
      ...
      pl: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Usuń",
            choose: {
              files: { one: "Wybierz plik", other: "Wybierz pliki" },
              images: { one: "Wybierz obraz", other: "Wybierz obrazy" },
            },
          },
          dialog: {
            close: "Zamknij",
            ...
            tabs: {
              ...
              preview: {
                ...
                error: {
                  ...
                  size: {
                    title:
                      "Plik, który wybrałeś, przekracza dopuszczalny rozmiar",
                    text: "Spróbuj ponownie z innym plikiem.",
                  },
                  loadImage: {
                    title: "Błąd",
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Wybrałeś zbyt wiele plików. Maksimum to %max%.",
                  tooFewFiles:
                    "Wybrałeś %files%. Wymagane jest co najmniej %min%.",
      ...
      pt: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Excluir",
            choose: {
              files: { one: "Escolha um arquivo", other: "Escolha arquivos" },
              images: { one: "Escolha uma imagem", other: "Escolha imagens" },
            },
          },
          dialog: {
            done: "OK",
      ...
      ro: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Șterge",
            choose: {
              files: { one: "Alege un fișier", other: "Alege fișiere" },
              images: { one: "Alege o imagine", other: "Alege imagini" },
            },
          },
          dialog: {
            close: "Închide",
      ...
      ru: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Удалить",
            choose: {
              files: { one: "Выбрать файл", other: "Выбрать файлы" },
              images: {
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Вы выбрали слишком много файлов. %max% максимум.",
        ...
        pluralize: function (e) {
          return 1 == (((e / 10) % 10) | 0) || e % 10 == 0 || e % 10 > 4
            ? "many"
            : e % 10 == 1
              ? "one"
              : "few";
      ...
      sk: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Odstrániť",
            choose: {
              files: { one: "Vyberte súbor", other: "Vyberte súbory" },
              images: { one: "Vyberte obrázok", other: "Vyberte obrázky" },
            },
          },
          dialog: {
            close: "Zavrieť",
            ...
            tabs: {
              ...
              preview: {
                ...
                error: {
                  ...
                  size: {
                    title:
                      "Súbor, ktorý ste vybrali presahuje povolenú veľkosť.",
                    text: "Skúste to znovu s iným súborom.",
                  },
                  loadImage: {
                    title: "Chyba",
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Vybrali ste príliš veľa súborov. Maximum je %max%.",
                  tooFewFiles:
                    "Vybrali ste %files%. Potrebných je aspoň %min%.",
      ...
      sr: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Избаци",
            choose: {
              files: { one: "Изабери фајл", other: "Изабери фајлове" },
              images: { one: "Изабери слику", other: "Изабери слике" },
            },
          },
          dialog: {
            close: "Затвори",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooManyFiles:
                    "Изабрали сте превише фајлова. %max% је максимално.",
                  tooFewFiles:
                    "Изабрали сте %files%. Морате најмање %min% фајла.",
                  clear: "Избаци све",
                  done: "Додај",
                  file: {
      ...
      sv: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Ta bort",
            choose: {
              files: { one: "Välj fil", other: "Välj filer" },
              images: { one: "Välj en bild", other: "Välj bilder" },
            },
          },
          dialog: {
            done: "Klar",
      ...
      tr: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Kaldır",
            choose: {
              files: { one: "Dosya Seçin", other: "Dosya Seçin" },
              images: {
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooFewFiles:
                    "%files% dosya seçtiniz, en az %min% dosya olmalıdır.",
      ...
      uk: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Видалити",
            choose: {
              files: { one: "Вибрати файл", other: "Вибрати файли" },
              images: {
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  tooFewFiles:
                    "Ви вибрали %files%. Мінімальна кількість %min%.",
                  clear: "Видалити все",
                  done: "Додати",
                  file: {
      ...
      vi: {
        translations: {
          ...
          buttons: {
            ...
            remove: "Xóa",
            choose: {
              files: { other: "Lựa chọn các tệp" },
              images: { other: "Lựa chọn hình ảnh" },
            },
          },
          dialog: {
            close: "Đóng",
            ...
            tabs: {
              ...
              preview: {
                ...
                multiple: {
                  ...
                  question: "Thêm %files%?",
                  tooManyFiles:
                    "Bạn đã lựa chọn quá nhiều tệp. %max% là tối đa.",
      ...
      zhTW: {
        translations: {
          ...
          buttons: {
            ...
            remove: "刪除",
            choose: {
              files: { one: "選擇檔案", other: "選擇檔案" },
              images: { one: "選擇圖片", other: "選擇圖片" },
            },
          },
          dialog: {
            done: "完成",
    ...
    da = null,
    pa = {
      translations: Object.keys(ca).reduce(function (e, t) {
        return ((e[t] = ca[t].translations), e);
      }, {}),
      pluralize: Object.keys(ca).reduce(function (e, t) {
        return ((e[t] = ca[t].pluralize), e);
      }, {}),
      rebuild: function (e) {
        return ((da = null), ha(e));
      },
      t: function (e, t) {
        ...
        return (
          (a = ha()),
          null == (n = ma(e, a.translations)) &&
            a.lang !== fa.lang &&
            (n = ma(e, (a = fa).translations)),
          null != t &&
            (n =
              null != a.pluralize
                ? (null != (i = n[a.pluralize(t)])
                    ? i.replace("%1", t)
                    : void 0) || t
                : ""),
          n || ""
    ...
    fa = {
      lang: "en",
      translations: ca.en.translations,
      pluralize: ca.en.pluralize,
    },
    ha = function (e) {
      if (!da) {
        var t = ft(e),
          ...
          r = a.default.isFunction(t.localePluralize)
            ? t.localePluralize
            : pa.pluralize[i];
        da = { lang: i, translations: n, pluralize: r };
      }
      return da;
    },
    ma = function (e, t) {
      for (var a = e.split("."), i = 0, n = a.length; i < n; i++) {
        var r = a[i];
    ...
    ga = (function () {
      function e(t, i) {
        ...
        (s(this, e),
          (this.__uuid = null),
          (this.settings = ft(i)),
          (this.__fileColl = new ua(t)),
          (this.__allFilesDf = a.default.when.apply(
            a.default,
            w(this.files()),
          )),
          (this.__fileInfosDf =
            ((t = function () {
              var e, t, i, r;
              for (r = [], e = 0, t = (i = this.files()).length; e < t; e++)
                ((n = i[e]),
                  r.push(
                    n.then(null, function (e, t) {
                      return a.default.when(t);
                    }),
                  ));
              return r;
            }.call(r)),
            a.default.when.apply(a.default, w(t)))),
          (this.__createGroupDf = a.default.Deferred()),
        ...
        c(e, [
                      ...
                      .done(function (t) {
                        return (
                          ...
                          e.__buildInfo(function (t) {
                            return e.settings.imagesOnly && !t.isImage
                              ? e.__createGroupDf.reject("image", t)
                              : e.__createGroupDf.resolve(t);
                          })
                        );
                      })
                      .fail(function (t) {
          ...
          },
          {
            ...
            value: function () {
              var e,
                ...
                n = this;
              return (
                (this.__apiDf = a.default.Deferred()),
                (this.__progressState = "uploading"),
                (t = function (e) {
                ...
                this.__allFilesDf
                  .done(function () {
                    return ((n.__progressState = "uploaded"), e());
                  })
                  .fail(t),
                this.__createGroupDf
                  .done(function (t) {
                    return ((n.__progressState = "ready"), e(), i(t));
                  })
                  .fail(t)
              );
            },
          },
          {
            ...
            value: function () {
              var e, t, a, i, n;
              for (
                a = 0, e = 0, t = (n = this.__fileColl.lastProgresses()).length;
                e < t;
                e++
              )
                a +=
                  ((null != (i = n[e]) ? i.progress : void 0) || 0) / n.length;
              return {
                state: this.__progressState,
                uploadProgress: a,
                progress: "ready" === this.__progressState ? 1 : 0.9 * a,
              };
            },
          },
          {
            ...
            value: function (e) {
              ...
              return (
                (t = {
                  ...
                  cdnUrl: this.__uuid
                    ? ""
                        ...
                        .concat(this.__uuid, "/")
                    : null,
                  name: pa.t("file", this.__fileColl.length()),
                ...
                this.__fileInfosDf.done(function () {
                  for (
                    var a, i, n, r = arguments.length, o = new Array(r), l = 0;
                    l < r;
                    l++
                  )
                    o[l] = arguments[l];
                  for (i = 0, n = o.length; i < n; i++)
                    ((a = o[i]),
                      (t.size += a.size),
                      a.isImage || (t.isImage = !1),
                      a.isStored || (t.isStored = !1));
                  return e(t);
                })
              );
            },
                  ...
                  ? this.__fileInfosDf.done(function () {
                      ...
                      return ye(
                        ...
                        "POST",
                        {
                          ...
                          files: (function () {
                            var e, t, a;
                            for (a = [], e = 0, t = i.length; e < t; e++)
                              ((r = i[e]),
                                a.push(
                                  "/"
                                    .concat(r.uuid, "/")
                                    .concat(r.cdnUrlModifiers || ""),
                                ));
                            return a;
                          })(),
                        },
                        {
                          ...
                          retryConfig: t.settings.retryConfig,
                        },
                      )
                        .fail(function (a) {
                          return (
                            t.settings.debugUploads &&
                              z(
                                "Can't create group.",
                                t.settings.publicKey,
                                a.message,
          ...
          },
          {
            ...
            value: function () {
              return (
                this.__api || (this.__api = $(this, ["promise", "files"])),
                this.__api
              );
            },
          },
    ...
    _a = (function (e) {
      ...
      function a(e, i) {
        ...
        return (
          s(this, a),
          (r = ea("ready", e.files, i)),
          ((n = t.call(this, r, i)).__data = e),
          n
        );
      }
      return (
    ...
    va = function () {
      ...
      for (t = [], i = 0, r = s.length; i < r; i++)
        if (((a = s[i]), ta(a))) t.push(a);
        else if (ia(a))
          for (n = 0, o = (l = a.files()).length; n < o; n++)
            ((e = l[n]), t.push(e));
      return new ga(t, u).api();
    },
    ba = function (e, t) {
      var i, n;
      return (
        ...
        (n = re.exec(e))
          ? ye(
              "".concat(t.urlBase, "/group/info/"),
              "GET",
              { jsonerrors: 1, pub_key: t.publicKey, group_id: n[0] },
              {
                headers: { "X-UC-User-Agent": t._userAgent },
              ...
              .done(function (e) {
                var a;
                return ((a = new _a(e, t)), i.resolve(a.api()));
              })
          : i.reject(),
        i.promise()
      );
    ...
    ya = {};
  T() &&
    a.default(window).on("message", function (e) {
      var t,
        a,
        i,
        n,
      ...
      if ((null != n ? n.type : void 0) && n.type in ya) {
        for (o = [], t = 0, i = (r = ya[n.type]).length; t < i; t++)
          ((a = r[t]), l.source === a[0] ? o.push(a[1](n)) : o.push(void 0));
        return o;
      }
    });
  var wa = function (e, t, a) {
      return (e in ya || (ya[e] = []), ya[e].push([t, a]));
    },
    xa = function (e, t) {
      if (e in ya)
        return (
          (ya[e] = a.default.grep(ya[e], function (e) {
            return e[0] !== t;
          })),
          ya[e]
        );
        ...
        (s(this, e),
          ...
          this.dialogApi.progress(function (e) {
            return (
              e === o.name &&
                (o.__createIframe(),
                o.container.find(".uploadcare--tab__iframe").focus()),
              o.__sendMessage({
        ...
        c(e, [
          {
            ...
            value: function () {
              ...
              return (
                ...
                ""
                  .concat(this.settings.socialBase, "/window3/")
                  .concat(this.name, "?") + a.default.param(e)
              );
            },
          },
          {
            ...
            value: function (e) {
              var t, a;
              return null != (t = this.iframe) &&
                null != (a = t[0].contentWindow)
                  ...
                  (this.iframe = a
                    ...
                    .on("load", function () {
                      ...
                      for (
                        ...
                        ((s = r[e]),
                          t.__sendMessage({ type: "embed-css", url: s }));
                      for (a = 0, n = (o = ka.styles).length; a < n; a++)
                        ((l = o[a]),
                          t.__sendMessage({ type: "embed-css", style: l }));
                    })),
                  this.container.addClass("uploadcare--tab_remote"),
                  (e = this.iframe[0].contentWindow),
                  wa("file-selected", e, function (e) {
                    var i, n, r;
                    return (
                      (r = (function () {
                        var a, i, n, r, o;
                        if (e.alternatives)
                          for (
                            a = 0, n = (r = t.settings.preferredTypes).length;
                            a < n;
                            a++
                          )
                            for (i in ((o = r[a]), (o = ue(o)), e.alternatives))
                              if (o.test(i)) return e.alternatives[i];
                        return e.url;
                      })()),
                      (n = a.default.extend({ source: t.name }, e.info || {})),
                      (i = new Gt(r, t.settings, n)),
                      e.filename && i.setName(e.filename),
                      null != e.is_image && i.setIsImage(e.is_image),
                      t.dialogApi.addFiles([i.promise()])
                    );
                  }),
                  wa("open-new-window", e, function (e) {
                    var a, i, n;
                    if (
                      (t.settings.debugUploads &&
                        A("Open new window message.", t.name),
                      (i = window.open(e.url, "_blank")))
                    )
                      return (
                        (n = function () {
                          return (
                            t.settings.debugUploads &&
                              A("Window is closed.", t.name),
                            t.__sendMessage({ type: "navigate", fragment: "" })
                          );
                        }),
                        "closed" in i
                          ? (a = setInterval(function () {
                              if (i.closed) return (clearInterval(a), n());
                            }, 100))
                          : i.addEventListener("exit", n)
                      );
                    C("Can't open new window. Possible blocked.", t.name);
                  }),
                  this.dialogApi.done(function () {
                    return (xa("file-selected", e), xa("open-new-window", e));
                  })
                );
            },
          },
    ...
    Aa = {
      ...
      utils: {
        ...
        image: {
          ...
          replaceJpegChunk: Ft,
          getExif: Tt,
          parseExifOrientation: Ot,
          hasTransparency: Bt,
        },
        pusher: { getPusher: Wt },
        isFileGroup: ia,
        valueToGroup: na,
        isFileGroupsEqual: ra,
      },
      settings: {
        globals: dt,
        build: ft,
      ...
      expose: function (e, t) {
        for (
          ...
          var s = a[o];
          (n[s] || (n[s] = {}), (n = n[s]), (r = null != r ? r[s] : void 0));
        }
        n[i] = t || r[i];
      },
    };
  ...
  var Sa = {
      ...
      version: "3.21.0",
      jQuery: a.default,
      defaults: r(r({}, Ke), {}, { allTabs: et.tabs.all }),
      globals: pt,
      start: pt,
      fileFrom: $t,
      filesFrom: ea,
  ...
  var ja = {
      dialog: function () {
        return '<div class="uploadcare--dialog"><div class="uploadcare--dialog__container"><button type="button" title="'
          ...
          .concat(pa.t("dialog.footer.link"), "</a></div></div>");
      },
      dialog__panel: function () {
        return '<div class="uploadcare--panel"><div class="uploadcare--menu uploadcare--panel__menu"><button type="button" title="'
          .concat(pa.t("dialog.openMenu"), '" aria-label="')
          .concat(
            pa.t("dialog.openMenu"),
          ...
          .concat(pa.t("dialog.footer.link"), "</a></div></div></div>");
      },
      ...
      "tab-camera-capture": function () {
        return '<div class="uploadcare--tab__content"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title">'
          ...
          .concat(
            pa.t("dialog.tabs.camera.capture"),
          ...
          .concat(
            pa.t("dialog.tabs.camera.startRecord"),
            "</button></div></div>",
          );
      },
      "tab-camera": function () {
        return '<div class="uploadcare--tab__content"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title">'
          ...
          .concat(
            pa.t("dialog.tabs.camera.mirror"),
          ...
          .concat(
            pa.t("dialog.tabs.camera.cancelRecord"),
      ...
      "tab-preview-error": function (e) {
        ...
        return '<div class="uploadcare--tab__content uploadcare--preview__content uploadcare--error"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            pa.t("dialog.tabs.preview.error." + a + ".title") ||
              pa.t("dialog.tabs.preview.error.default.title"),
            '</div><div class="uploadcare--text">',
          )
          .concat(
            (t && (null == i ? void 0 : i.message)) ||
              pa.t("serverErrors.".concat(null == i ? void 0 : i.code)) ||
              (null == i ? void 0 : i.message) ||
              pa.t("dialog.tabs.preview.error." + a + ".text") ||
              pa.t("dialog.tabs.preview.error.default.text"),
            '</div><button type="button" class="uploadcare--button uploadcare--preview__back">',
          )
          .concat(
            pa.t("dialog.tabs.preview.error." + a + ".back") ||
              pa.t("dialog.tabs.preview.error.default.back"),
            "</button></div>",
          );
      },
      "tab-preview-image": function (e) {
        ...
        return '<div class="uploadcare--tab__header"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            pa.t("dialog.tabs.preview.image.title"),
            '</div></div><div class="uploadcare--tab__content uploadcare--preview__content"><div class="uploadcare--media"><img src="',
          )
          .concat(t, '" title="')
          .concat(Ta(i), '" alt="')
          .concat(
          ...
          .concat(
            pa.t("dialog.tabs.preview.image.change"),
          ...
          .concat(pa.t("dialog.tabs.preview.done"), "</button></div>");
      },
      "tab-preview-multiple-file": function () {
        return '<div class="uploadcare--file uploadcare--files__item uploadcare--file_status_uploading"><div class="uploadcare--file__description" tabindex="0"><div class="uploadcare--file__preview"></div><div class="uploadcare--file__name">'.concat(
          pa.t("dialog.tabs.preview.unknownName"),
      ...
      "tab-preview-multiple": function () {
        return '<div class="uploadcare--tab__header"><div id="preview__title" class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title" role="status" aria-live="assertive"></div></div><div class="uploadcare--tab__content uploadcare--preview__content"><div class="uploadcare--files"></div></div><div class="uploadcare--footer uploadcare--tab__footer"><div class="uploadcare--footer__additions uploadcare--preview__message"></div><button type="button" class="uploadcare--button uploadcare--footer__button uploadcare--preview__back">'
          .concat(
            pa.t("dialog.tabs.preview.multiple.clear"),
          ...
          .concat(pa.t("dialog.tabs.preview.multiple.done"), "</button></div>");
      },
      "tab-preview-regular": function (e) {
        ...
        return '<div class="uploadcare--tab__header"><div id="tab__title" class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title" role="status" aria-live="assertive">'
          .concat(
            pa.t("dialog.tabs.preview.regular.title"),
          ...
          .concat(Ta(t.name) || pa.t("dialog.tabs.preview.unknownName"), " ")
          .concat(
            ve(t.size, "", ", "),
          ...
          .concat(
            pa.t("dialog.tabs.preview.change"),
            '</button> <button type="button" class="uploadcare--button uploadcare--button_primary uploadcare--footer__button uploadcare--preview__done" aria-describedby="tab__title">',
          )
          .concat(pa.t("dialog.tabs.preview.done"), "</button></div>");
      },
      "tab-preview-unknown": function () {
        return '<div class="uploadcare--tab__header"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            pa.t("dialog.tabs.preview.unknown.title"),
          ...
          .concat(pa.t("dialog.tabs.preview.unknown.done"), "</button></div>");
      },
      "tab-preview-video": function () {
        return '<div class="uploadcare--tab__header"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            pa.t("dialog.tabs.preview.video.title"),
          ...
          .concat(
            pa.t("dialog.tabs.preview.video.change"),
            '</button> <button type="button" class="uploadcare--button uploadcare--button_primary uploadcare--footer__button uploadcare--preview__done">',
          )
          .concat(pa.t("dialog.tabs.preview.done"), "</button></div>");
      },
      "tab-url": function () {
        return '<div class="uploadcare--tab__content"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title">'
          .concat(
            pa.t("dialog.tabs.url.title"),
            '</div><div class="uploadcare--text">',
          )
          .concat(
            pa.t("dialog.tabs.url.line1"),
            '</div><div class="uploadcare--text">',
          )
          .concat(
            pa.t("dialog.tabs.url.line2"),
            '</div><form class="uploadcare--form"><input type="text" class="uploadcare--input" placeholder="',
          )
          .concat(
            pa.t("dialog.tabs.url.input"),
            '"> <button type="submit" class="uploadcare--button uploadcare--button_primary uploadcare--tab__action-button" type="submit">',
          )
          .concat(pa.t("dialog.tabs.url.button"), "</button></form></div>");
      },
      "widget-button": function (e) {
        var t = e.caption,
          a = e.name;
        return '<button type="button" class="uploadcare--widget__button uploadcare--widget__button_type_'
          .concat(a, '">')
          .concat(t, "</button>");
      },
      "widget-file-name": function (e) {
        var t = e.name,
          a = e.size;
        return '<div class="uploadcare--link uploadcare--widget__file-name" tabindex="0" role="link">'
          .concat(
            Ta(de(t, 20)),
            '</div><div class="uploadcare--widget__file-size">, ',
          )
          .concat(ve(a), "</div>");
      },
      widget: function () {
  ...
  T() &&
    ht.add(function (e) {
      ...
      return (
        ...
        a.default("head").prepend(i)
      );
    });
  var Ia = function (e) {
      return (
        "[data-status=started], [data-status=error]",
        !e
          .find(".uploadcare--widget")
          .is("[data-status=started], [data-status=error]")
      );
    },
    Pa = function (e, t) {
      return (
        e.attr("data-uploadcare-submitted", t),
        e.find(":submit").attr("disabled", t)
      );
    },
    Ma = '[role~="uploadcare-upload-form"]',
    Ea = Ma + "[data-uploadcare-submitted]";
  if (T()) {
    (a.default(document).on("submit", Ma, function () {
      var e;
      return ((e = a.default(this)), !!Ia(e) || (Pa(e, !0), !1));
    }),
      a.default(document).on("loaded.uploadcare", Ea, function () {
        return a.default(this).submit();
      }));
    a.default(document).on(
      "ready.uploadcare error.uploadcare",
      Ea,
      function () {
        var e;
        if (((e = a.default(this)), Ia(e))) return Pa(e, !1);
      },
    );
  }
  var Oa = [
        ...
        return X(function () {
          ...
          if ((e = document.activeElement) && e !== document.body)
            return a
              ...
              .one("blur", function () {
                return a.default(e).removeClass("uploadcare--mouse-focused");
              });
        });
      })
      .on("keypress", Oa, function (e) {
        if (13 === e.which || 32 === e.which)
          return (
            a.default(this).click(),
            e.preventDefault(),
            e.stopPropagation()
          );
      });
  var Ua = (function () {
      function e(t) {
        (s(this, e),
          (this.renderer = O ? new Va(t) : new Ra(t)),
          (this.observed = null));
      }
      return (
        c(e, [
            ...
            value: function (e, t) {
              ...
              return (
                ...
                "resolved" === this.observed.state()
                  ...
                  : this.observed
                      .progress(function (t) {
                        e === i.observed && i.renderer.setValue(a(t));
                      })
                      .always(function (t) {
    ...
    Ra = (function (e) {
      ...
      function a() {
        ...
        return (
          s(this, a),
          (e = t.apply(this, arguments)).element.addClass(
            "uploadcare--progress_type_text",
          ),
          e.element.html(Da("progress__text")),
          (e.text = e.element.find(".uploadcare--progress__text")),
          e
        );
      }
      return (
    ...
    Va = (function (e) {
      ...
      function i() {
        ...
        return (
          s(this, i),
          ((e = t.apply(this, arguments)).canvasEl = a
            .default("<canvas>")
      ...
      return (
        c(i, [
            ...
            value: function () {
              ...
              (window.cancelAnimationFrame(this.__rafId),
                (this.__rafId = window.requestAnimationFrame(function () {
                  var t = Math.floor(
                      Math.min(e.element.width(), e.element.height()),
                    ),
                    a = 2 * t;
                  if (t) {
                    (e.canvasEl.width === a && e.canvasEl.height === a) ||
                      ((e.canvasEl.width = a), (e.canvasEl.height = a));
            ...
            value: function (e) {
              ...
              ((i = this.val),
                ...
                (this.__animIntervalId = setInterval(function () {
                  var r;
                  ((r = i + ((new Date() - a) / 1e3) * t),
                    (r = (t > 0 ? Math.min : Math.max)(r, e)) === e &&
                      n.__stopAnimation(),
                    n.__setValue(r));
                }, 15)));
            },
          },
          {
            key: "__stopAnimation",
            value: function () {
              (this.__animIntervalId && clearInterval(this.__animIntervalId),
          ...
          },
          {
            ...
            value: function (e) {
              ((this.val = e),
                this.element.attr("aria-valuenow", (100 * e).toFixed(0)),
                this.update());
            },
          },
          {
            ...
            value: function (e) {
              ...
              (this.__stopAnimation(),
                t ? this.__setValue(e) : this.__animateValue(e));
            },
          },
        ]),
        i
    ...
    qa = function (e, t, a) {
      return (
        (a = ft(a)),
        Na(e, function (e, i) {
          return t(a.multiple ? ea(e, i, a) : $t(e, i[0], a));
        })
      );
    },
    Na = La
      ? function (e, t) {
          (Ka(e),
            a.default(e).on({
              ...
              drop: function (e) {
                var i, n, r, o, l, s;
                if ((e.preventDefault(), (i = e.originalEvent.dataTransfer))) {
                  if (i.files.length) return t("object", i.files);
                  for (
                    s = [],
                      n = 0,
                      r = (o = i.getData("text/uri-list").split()).length;
                    n < r;
                    n++
                  )
                    ((l = o[n]),
                      (l = a.default.trim(l)) && "#" !== l[0] && s.push(l));
                  return s ? t("url", s) : void 0;
                }
              },
            }));
        }
          ...
          return (
            ...
            (i = function (t) {
              if (r !== t)
                return (
                  (r = t),
                  a.default(e).toggleClass("uploadcare--dragging", t)
                );
            }),
            a.default(t || e).on({
              dragenter: function () {
    ...
    Ga = (function () {
      function e(t, i) {
        (s(this, e),
          (this.settings = t),
          (this.element = i),
          (this.content = a.default(Da("widget"))),
            ...
            value: function (e) {
              var t =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : "";
              return a
                .default(Da("widget-button", { name: e, caption: t }))
              ...
              return (
                ...
                e.progress(function (a) {
                  if (e === t.__file)
                    switch (a.state) {
                      case "uploading":
                        return t.statusText.text(pa.t("uploading"));
                      case "uploaded":
                        return t.statusText.text(pa.t("loadingInfo"));
                    }
                })
              );
            },
          },
          {
            ...
            value: function (e, t) {
              var a =
                ...
                pa.t("serverErrors.".concat(null == t ? void 0 : t.code)) ||
                (null == t ? void 0 : t.message) ||
                pa.t("errors.".concat(e || "default"));
              return (
    ...
    Xa = (function () {
      function e(t, a, i, n, r) {
        (s(this, e),
          ...
          (this.settings = n),
          (this.name = r),
          this.container.append(Da("tab-file")),
        ...
        c(e, [
          {
            ...
            value: function () {
              var e,
                t = this;
              if (((e = this.container.find(".uploadcare--draganddrop")), U))
                return (
                  Na(e, function (e, a) {
                    return (
                      t.settings.multiple
                        ? t.dialogApi.addFiles(e, a)
                        : t.dialogApi.addFiles(e, [a[0]]),
                      t.dialogApi.switchTab("preview")
                    );
                  }),
            ...
            value: function () {
              ...
              return (
                ...
                M
                  ? e.on("click", function () {
                      return (
                        ge(t.container, t.settings, function (e) {
                          return (
                            t.dialogApi.addFiles("object", e.files),
                            t.dialogApi.switchTab("preview")
                          );
                        }),
                        !1
                  ...
                  : me(e, this.settings, function (e) {
                      return (
                        t.dialogApi.addFiles("input", [e]),
                        t.dialogApi.switchTab("preview")
                      );
                    })
              );
            ...
            value: function () {
              ...
              for (
                ...
                "file" !== (r = n[e]) &&
                  "url" !== r &&
                  "camera" !== r &&
                  this.dialogApi.isTabVisible(r) &&
                  ((i += 1) > 5 || a.append([this.__tabButton(r), " "]));
              return (
                a.find(".uploadcare--file-source_all").on("click", function () {
                  return o.dialogApi.openMenu();
                }),
                i > 5 && a.addClass("uploadcare--file-sources__items_many"),
                this.container
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return (
                (t = a
                  .default(
                    "<svg width='32' height='32'><use xlink:href='#uploadcare--icon-".concat(
                      e,
                      "'/></svg>",
                    ),
                  )
                  ...
                  .attr(
                    "class",
                    "uploadcare--icon uploadcare--file-source__icon",
                  )),
                a
                  .default("<button>")
                  ...
                  .attr("type", "button")
                  .attr("title", pa.t("dialog.tabs.names.".concat(e)))
                  .attr("data-tab", e)
                  .append(t)
                  .on("click", function () {
                    return i.dialogApi.switchTab(e);
                  })
              );
            },
          },
    ...
    Ya = (function () {
      function e(t, i, n, r, o) {
        ...
        (s(this, e),
          ...
          (this.settings = r),
          (this.name = o),
          this.container.append(Da("tab-url")),
          (u = this.container.find(".uploadcare--input")).on(
            "change keyup input",
            function () {
              var e = !a.default.trim(this.value);
          ...
          this.container.find(".uploadcare--form").on("submit", function () {
            ...
            return (
              e &&
                (c.dialogApi.addFiles("url", [[e, { source: "url-tab" }]]),
  ...
  ((Wa = /^[a-z][a-z0-9+\-.]*:?\/\//),
    (Ha = function (e) {
      return ((e = a.default.trim(e)), Wa.test(e) ? e : "http://" + e);
    }));
  var Ja = T() && "https:" === document.location.protocol,
    Za = (function () {
      function e(t, a, i, n, r) {
        var o;
        if (
          ...
          (this.container.append(Da("tab-camera-capture")),
            ...
            this.settings.imagesOnly && o.hide());
        else {
          if (!this.__checkCompatibility())
            return void this.dialogApi.hideTab(this.name);
          this.__initCamera();
        }
      }
      return (
        c(e, [
          ...
          },
          {
            ...
            value: function (e) {
              return (
                this.dialogApi.addFiles("object", e.files),
          ...
          },
          {
            ...
            value: function () {
              ...
              ((this.__loaded = !1),
                ...
                this.container.append(Da("tab-camera")),
                this.container.addClass("uploadcare--camera"),
              ...
              (this.container
                ...
                (this.MediaRecorder &&
                  ...
                  t.hide(),
                (this.video = this.container.find(
                ...
                this.dialogApi.progress(function (t) {
                  t === e.name
                    ? e.__loaded || e.__requestDevicesList()
                    : e.__loaded && Ja && e.__revoke();
                }),
          ...
          },
          {
            ...
            value: function () {
              (navigator.mediaDevices &&
                ...
                Ja ||
                  C(
                    "Camera is not allowed for HTTP. Please use HTTPS connection.",
                  ));
              var e = "localhost" === document.location.hostname;
              return !!this.getUserMedia && Uint8Array && (Ja || e);
            },
          },
          {
            key: "__checkCapture",
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (this.container
                .removeClass(t)
                .addClass("uploadcare--camera_status_".concat(e)),
              ...
              this.enumerateVideoDevices
                ? this.getUserMedia({ video: !0, audio: !0 })
                    ...
                    .then(function (t) {
                      var a;
                      ((e.__groupId =
                        null == t || null === (a = t[0]) || void 0 === a
                          ? void 0
                          : a.groupId),
                        e.__renderDevicesList(t));
                    })
                    .then(function () {
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                this.__groupId &&
                  ((t.video.groupId = { exact: this.__groupId }),
                  (t.audio = t.audio && { exact: this.__groupId })),
                this.getUserMedia
                  .call(navigator, t)
                  .then(function (t) {
                    (e.__setState("ready"),
                    ...
                    var a = e.__getGroupIdByStream(t);
                    return (
                      (e.__groupId = a),
                      "srcObject" in e.video[0]
                        ...
                        : (e.URL
                            ? ((e.__streamObject = e.URL.createObjectURL(t)),
                              e.video.prop("src", e.__streamObject))
                            : e.video.prop("src", t),
                          e.video[0].play())
                    );
                  })
                  .catch(function (t) {
                    ...
                    return (
                      ...
                      (a.NotAllowedError = function () {
                        e.__setState("denied");
                      }),
                      (a.other = function () {
                        (e.__setState("denied"),
                          console.warn("Camera error occurred: " + t.name));
                      }),
                      (a[t.name] || a.other)(),
                      (e.__loaded = !1),
                      e.__loaded
              ...
              (this.__setState("requested"),
                ...
                this.__stream &&
                  ...
                  this.__stream.getTracks
                    ? a.default.each(this.__stream.getTracks(), function () {
                        return "function" == typeof this.stop
                          ? this.stop()
                          : void 0;
                      })
          ...
          },
          {
            ...
            value: function () {
              var e,
                ...
                r = this;
              return (
                (n = (i = this.video[0]).videoWidth),
                (a = i.videoHeight),
                ((e = document.createElement("canvas")).width = n),
                (e.height = a),
                (t = e.getContext("2d")),
                this.mirrored && (t.translate(n, 0), t.scale(-1, 1)),
                t.drawImage(i, 0, 0, n, a),
                we(e, "image/jpeg", 0.9, function (t) {
                  return (
                    (e.width = e.height = 1),
                    (t.name = "camera.jpg"),
                    r.dialogApi.addFiles("object", [[t, { source: "camera" }]]),
                    r.dialogApi.switchTab("preview")
                  );
                })
              );
            },
          },
          {
            ...
            value: function () {
              ...
              var t = {},
                i = this.settings.videoPreferredMimeTypes;
              if (null != i) {
                var n = (function (e, t) {
                  for (var a = e.length, i = 0; i < a; ) {
                    var n = e[i];
                    if (t(n)) return n;
                    i++;
                  }
                })(a.default.isArray(i) ? i : [i], function (t) {
              ...
              return (
                ...
                null !== this.settings.audioBitsPerSecond &&
                  (t.audioBitsPerSecond = this.settings.audioBitsPerSecond),
                null !== this.settings.videoBitsPerSecond &&
                  (t.videoBitsPerSecond = this.settings.videoBitsPerSecond),
                0 !== Object.keys(t).length
                  ? (this.__recorder = new this.MediaRecorder(this.__stream, t))
            ...
            value: function () {
              ...
              return (
                ...
                (this.__recorder.onstop = function () {
                  var t, a;
                  return (
                    (t = new window.Blob(e.__chunks, {
                      type: e.__recorder.mimeType,
                    })),
                    (a = e.__guessExtensionByMime(e.__recorder.mimeType)),
                    (t.name = "record.".concat(a)),
          ...
          },
          {
            ...
            value: function (e) {
              var t = this,
                i = this.container.find(".uploadcare--camera__device-select");
              (i.empty(),
                e.forEach(function (e, n) {
                  var r = t.__groupId ? e.groupId === t.__groupId : 0 === n;
                  i.append(
                    a.default("<option>", {
                      value: e.groupId,
                      text:
                        e.label ||
                        ""
                          .concat(pa.t("dialog.tabs.camera.camera"), " #")
                          .concat(n + 1),
                      selected: r,
                    }),
                  );
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (e && "video" === (e = e.split("/"))[0]) {
                var a = (e = e.slice(1).join("/")).split(";")[0];
                if (t[a]) return t[a];
              }
              return "avi";
            },
  ...
  T() &&
    (function (e) {
      ((e.Jcrop = function (t, a) {
        var i,
          n = e.extend({}, e.Jcrop.defaults);
        function r(e) {
          return Math.round(e) + "px";
        }
        function l(e) {
          return n.baseClass + "-" + e;
        }
        function s(t) {
          var a = e(t).offset();
          return [a.left, a.top];
        ...
        function c(t) {
          ("object" !== o(t) && (t = {}),
            ...
            e.each(
              ...
              function (e, t) {
                "function" != typeof n[t] && (n[t] = function () {});
              },
            ));
        }
        function d(e, t) {
          if (((i = s(C)), "move" === e))
            return X.activateHandlers(
              (function (e) {
                var t = e;
                return (
                  Y.watchKeys(),
                  function (e) {
                    (H.moveOffset([e[0] - t[0], e[1] - t[1]]),
                      (t = e),
                      G.update());
                  }
                );
        ...
        function m(e) {
          (H.getFixed(), G.enableHandles(), G.done());
        }
        function g() {
          var t = e("<div></div>").addClass(l("tracker"));
          return (t.css({ opacity: 0, backgroundColor: "white" }), t);
        }
        ("object" !== o(t) && (t = e(t)[0]),
          "object" !== o(a) && (a = {}),
          c(a));
        var _,
          ...
          z = !0;
        if ("IMG" == t.tagName) {
          if (0 != k[0].width && 0 != k[0].height)
            (k.width(k[0].width), k.height(k[0].height));
          else {
            var A = new Image();
            ((A.src = k[0].src), k.width(A.width), k.height(A.height));
          }
          var C = k.clone().removeAttr("id").css(x).show();
          (C.width(k.width()), C.height(k.height()), k.after(C).hide());
        } else
          ((C = k.css(x).show()), (z = !1), null === n.shade && (n.shade = !0));
        ((_ = C),
          (v = n.boxWidth),
          (b = n.boxHeight),
          (y = _.width()),
          (w = _.height()),
          y > v && v > 0 && ((y = v), (w = (v / _.width()) * _.height())),
          w > b && b > 0 && ((w = b), (y = (b / _.height()) * _.width())),
          (U = _.width() / y),
          (B = _.height() / w),
          _.width(y).height(w));
        var S = C.width(),
          ...
          T = e("<div></div>")
            ...
            .height(F)
            .addClass(l("holder"))
            .css({ position: "relative", backgroundColor: n.bgColor })
            .insertAfter(k)
            .append(C);
        ...
        var K = (function () {
            ...
            return {
              ...
              isSupported: e,
              support:
                !0 === n.touchSupport || !1 === n.touchSupport
                  ? n.touchSupport
                  : e(),
            };
          })(),
              ...
              if (!n.aspectRatio)
                return (function () {
                  var e,
                    t = r - a,
                    n = o - i;
                  P && Math.abs(t) > P && (r = t > 0 ? a + P : a - P);
                  M && Math.abs(n) > M && (o = n > 0 ? i + M : i - M);
                  O / B &&
                    Math.abs(n) < O / B &&
                    (o = n > 0 ? i + O / B : i - O / B);
                  E / U &&
                  ...
                  : ((s = r),
                    ...
                    (d = m < 0 ? i - f : i + f) < 0
                      ...
                      : d > F &&
                        ...
                        (s = h < 0 ? a - p : p + a))),
                s > a
                  ? (s - a < t ? (s = a + t) : s - a > l && (s = a + l),
                    (d = d > i ? i + (s - a) / e : i - (s - a) / e))
                  : s < a &&
                    (a - s < t ? (s = a - t) : a - s > l && (s = a - l),
                    (d = d > i ? i + (a - s) / e : i - (a - s) / e)),
                s < 0 ? ((a -= s), (s = 0)) : s > S && ((a -= s - S), (s = S)),
                d < 0 ? ((i -= d), (d = 0)) : d > F && ((i -= d - F), (d = F)),
                c(u(a, i, s, d))
              );
            }
            function s(e) {
          ...
          W = (function () {
            ...
            function l(e) {
              (i.top.css({ left: r(e.x), width: r(e.w), height: r(e.y) }),
                i.bottom.css({
                  top: r(e.y2),
                  left: r(e.x),
                  width: r(e.w),
                ...
                i.right.css({ left: r(e.x2), width: r(S - e.x2) }),
                i.left.css({ width: r(e.x) }));
            }
            function s() {
              return e("<div></div>")
                .css({
                  position: "absolute",
                  backgroundColor: n.shadeColor || n.bgColor,
                })
                .appendTo(a);
            }
            function u() {
              t ||
                ...
                a.insertBefore(C),
                o(),
                G.setBgOpacity(1, 0, 1),
                j.hide(),
                c(n.shadeColor || n.bgColor, 1),
                G.isAwake() ? p(n.bgOpacity, 1) : p(1, 1));
            }
            function c(e, t) {
              Z(f(), e, t);
            }
            function d() {
              t &&
                ...
                (t = !1),
                G.isAwake()
                  ? G.setBgOpacity(n.bgOpacity, 1, 1)
                  : G.setBgOpacity(1, 1, 1),
                Z(T, 0, 1));
            }
            function p(e, i) {
              t &&
            ...
            return {
              ...
              disable: d,
              resize: function (e, t) {
                (i.left.css({ height: r(t) }), i.right.css({ height: r(t) }));
              },
              refresh: function () {
                (n.shade ? u() : d(), G.isAwake() && p(n.bgOpacity));
              },
              opacity: p,
            };
          })(),
          G = (function () {
            ...
            function o(t) {
              return (function (t) {
                var a = e("<div></div>")
                  .mousedown(f(t))
                  .css({ cursor: t + "-resize", position: "absolute" })
                  .append("<div></div>")
                  .addClass("ord-" + t);
                return (
                  K.support && a.on("touchstart.jcrop", K.createDragger(t)),
                  I.append(a),
                  a
                );
              })(t).addClass(l("handle"));
            ...
            function s() {
              var e = H.getFixed();
              (H.setPressed([e.x, e.y]), H.setCurrent([e.x2, e.y2]), u());
            }
            function u(e) {
              if (t) return c(e);
            }
            function c(e) {
              var a,
                ...
                o = H.getFixed();
              (!(function (e, t) {
                I.width(Math.round(e)).height(Math.round(t));
              })(o.w, o.h),
                (a = o.x),
                (i = o.y),
                n.shade || j.css({ top: r(-i), left: r(-a) }),
                I.css({ top: r(i), left: r(a) }),
                n.shade && W.updateRaw(o),
                t ||
                  (function () {
                    (I.show(), n.shade ? W.opacity(N) : d(N, !0));
                    t = !0;
                  })(),
                e ? n.onSelect.call($, h(o)) : n.onChange.call($, h(o)));
            }
            function d(e, a, i) {
              (t || a) &&
                (n.bgFade && !i
            ...
            function p() {
              if (n.allowResize) return !0;
            }
            function m(e) {
              e || p();
            }
            (e.isArray(n.createHandles) &&
              (function (e) {
                var t;
                for (t = 0; t < e.length; t++) i[e[t]] = o(e[t]);
              })(n.createHandles),
              n.drawBorders &&
                e.isArray(n.createBorders) &&
                (function (t) {
                  var i, n, r, o;
              ...
              e(document).on("touchstart.jcrop-ios", function (t) {
                e(t.currentTarget).hasClass("jcrop-tracker") &&
                  t.stopPropagation();
              }));
            var _ = g()
              .mousedown(f("move"))
            ...
            return (
              K.support && _.on("touchstart.jcrop", K.createDragger("move")),
              D.append(_),
              {
                updateVisible: u,
                update: c,
          ...
          X = (function () {
            ...
            function o(i) {
              return (
                ...
                R &&
                  ((R = !1),
                  a(u(i)),
                  G.isAwake() && n.onSelect.call($, h(H.getFixed())),
                  L.css({ zIndex: 290 }),
                  e(document).off(".jcrop"),
                  (t = function () {}),
                  (a = function () {})),
                !1
              );
            ...
            return (
              i || L.mousemove(r).mouseup(o).mouseout(o),
              C.before(L),
              {
                activateHandlers: function (n, u) {
                  return (
                    (R = !0),
                    (t = n),
                    (a = u),
                    ...
                    K.support &&
                      e(document)
                        .on("touchmove.jcrop", l)
                        .on("touchend.jcrop", s),
                    i &&
                      e(document)
                        .on("mousemove.jcrop", r)
                        .on("mouseup.jcrop", o),
                    !1
                  );
                },
          ...
          Y = (function () {
            var t = e('<input type="radio" />')
              ...
              a = e("<div></div>")
                ...
                .append(t);
            function i(e, t, a) {
              (n.allowMove && (H.moveOffset([t, a]), G.updateVisible(!0)),
                e.preventDefault(),
                e.stopPropagation());
            }
            return (
              n.keySupport &&
                ...
                a.append(t).insertBefore(C)),
              {
                watchKeys: function () {
                  n.keySupport && (t.show(), t.focus());
                },
              }
            );
          })();
        function J(e) {
          (!(function (e) {
            (H.setPressed([e[0], e[1]]),
              H.setCurrent([e[2], e[3]]),
              G.update());
          })([e[0] / U, e[1] / B, e[2] / U, e[3] / B]),
            n.onSelect.call($, h(H.getFixed())),
            G.enableHandles());
        }
        function Z(t, a, i) {
          var r = a || n.bgColor;
          n.bgFade &&
          e.fx.step.hasOwnProperty("backgroundColor") &&
          n.fadeTime &&
          !i
            ? t.animate(
                { backgroundColor: r },
        ...
        function Q(e) {
          (n.allowResize && (e || G.enableHandles()),
            G.setCursor(n.allowMove ? "move" : "default"),
            n.hasOwnProperty("trueSize") &&
              ((U = n.trueSize[0] / S), (B = n.trueSize[1] / F)),
            n.hasOwnProperty("setSelect") &&
              (J(n.setSelect), G.done(), delete n.setSelect),
            W.refresh(),
            n.bgColor != q &&
              (Z(
                n.shade ? W.getShades() : T,
                (n.shade && n.shadeColor) || n.bgColor,
              ),
              (q = n.bgColor)),
            N != n.bgOpacity &&
              ((N = n.bgOpacity), n.shade ? W.refresh() : G.setBgOpacity(N)),
            (P = n.maxSize[0] || 0),
            (M = n.maxSize[1] || 0),
            (E = n.minSize[0] || 0),
            (O = n.minSize[1] || 0),
            n.hasOwnProperty("outerImage") &&
              (C.attr("src", n.outerImage), delete n.outerImage),
            G.refresh());
        }
        Q(!0);
        var $ = {
          ...
          setClass: function (e) {
            T.removeClass().addClass(l("holder")).addClass(e);
          },
          disable: function () {
            ((n.disabled = !0), G.setCursor("default"));
          },
          enable: function () {
            ((n.disabled = !1), Q());
          },
          cancel: function () {
            (G.done(), X.activateHandlers(null, null));
          },
          release: G.release,
          destroy: function () {
            (T.remove(),
          ...
          ui: { holder: T, selection: I },
        };
        return (k.data("Jcrop", $), $);
      }),
        (e.fn.Jcrop = function (t, a) {
          var i;
          return (
            this.each(function () {
              if (e(this).data("Jcrop")) {
                ...
                "IMG" == this.tagName
                  ? e.Jcrop.Loader(this, function () {
                      (e(this).css({ display: "block", visibility: "hidden" }),
                        (i = e.Jcrop(this, t)),
                        e.isFunction(a) && a.call(i));
                    })
                  : (e(this).css({ display: "block", visibility: "hidden" }),
                    (i = e.Jcrop(this, t)),
                    e.isFunction(a) && a.call(i));
        ...
        (e.Jcrop.Loader = function (t, a, i) {
          var n = e(t),
            r = n[0];
          (n
            .on("load.jcloader", function t() {
              r.complete
                ? (n.off(".jcloader"), e.isFunction(a) && a.call(r))
                : window.setTimeout(t, 50);
            })
            .on("error.jcloader", function (t) {
              (n.off(".jcloader"), e.isFunction(i) && i.call(r));
            }),
            r.complete && e.isFunction(a) && (n.off(".jcloader"), a.call(r)));
        }),
        (e.Jcrop.defaults = {
          allowMove: !0,
          allowResize: !0,
  ...
  var Qa = /-\/crop\/([0-9]+)x([0-9]+)(\/(center|([0-9]+),([0-9]+)))?\//i,
    $a = (function () {
      function e(t, i) {
        var n =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        (s(this, e),
          (this.element = t),
          (this.originalSize = i),
          (this.__api = a.default.Jcrop(this.element[0], {
        ...
        c(e, [
          {
            ...
            value: function (e) {
              return (
                (this.crop = e),
                this.__api.setOptions({
                  aspectRatio: e.preferedSize
                    ? e.preferedSize[0] / e.preferedSize[1]
                    : 0,
                  minSize: e.notLess
                    ? pe(e.preferedSize, this.originalSize)
                    : [0, 0],
                })
              );
            },
          },
          {
            ...
            value: function (e) {
              ...
              return (
                e
                  ? ((t = e.center), (i = [e.width, e.height]))
                  : ((t = !0), (i = this.originalSize)),
                this.crop.preferedSize &&
                  (i = pe(this.crop.preferedSize, i, !0)),
                t
                  ? ((a = (this.originalSize[0] - i[0]) / 2),
                    (n = (this.originalSize[1] - i[1]) / 2))
                  : ((a = e.left || 0), (n = e.top || 0)),
                this.__api.setSelect([a, n, i[0] + a, i[1] + n])
              );
            },
          },
          {
            ...
            value: function (e) {
              var t = null != e ? e.match(Qa) : void 0;
              if (t)
                return {
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                {
                  left: (t = Math.round(Math.max(0, e.x))),
                  top: (a = Math.round(Math.max(0, e.y))),
                  width: Math.round(Math.min(this.originalSize[0], e.x2)) - t,
                  height: Math.round(Math.min(this.originalSize[1], e.y2)) - a,
                }
              );
            },
          },
    ...
    ei = (function () {
      function e(t, a, i, n, r) {
        ...
        (s(this, e),
          ...
          this.container.on(
            "click",
            ".uploadcare--preview__back:not(:disabled)",
            function () {
          ...
          this.container.on(
            "click",
            ".uploadcare--preview__done:not(:disabled)",
        ...
        c(e, [
          {
            ...
            value: function () {
              var e,
                ...
                r = this;
              return (
                (i = this.tabButton.find(".uploadcare--panel__icon")),
                (t = a.default.Deferred()),
                (n = function () {
                  var e, a, i, n, o;
                  for (
                    n = 0,
                      e = 0,
                      i = (a = r.dialogApi.fileColl.lastProgresses()).length;
                    e < i;
                    e++
                  )
                    n +=
                      ((null != (o = a[e]) ? o.progress : void 0) || 0) /
                      a.length;
                  return t.notify(n);
                }),
                this.dialogApi.fileColl.onAnyProgress(n),
                this.dialogApi.fileColl.onAdd.add(n),
                this.dialogApi.fileColl.onRemove.add(n),
                n(),
                (e = new Ua(i).listen(t.promise())),
    ...
    ti = (function (e) {
      p(i, e);
      var t = _(i);
      function i(e, n, r, o, l) {
        var u;
        return (
          s(this, i),
          ((u = t.apply(this, arguments)).container = e),
          (u.tabButton = n),
          (u.dialogApi = r),
          (u.settings = o),
          (u.name = l),
          a.default.each(u.dialogApi.fileColl.get(), function (e, t) {
            return u.__setFile(t);
          }),
          u.dialogApi.fileColl.onAdd.add(u.__setFile.bind(m(u))),
          (u.widget = null),
          (u.__state = null),
          u
        );
        ...
        c(i, [
          {
            ...
            value: function (e) {
              ...
              return (
                ...
                (a = J(this.__tryToLoadImagePreview.bind(this))),
                (i = J(this.__tryToLoadVideoPreview.bind(this))),
                ...
                this.file.progress(
                  t(function (t) {
                    ...
                    if (
                      ((o =
                        ((t = t.incompleteFileInfo).name || "") +
                        ve(t.size, "", ", ")),
                      n.container
                        .find(".uploadcare--preview__file-name")
                        .text(o),
                      (l = t.sourceInfo),
                      (r = q),
                      l.file && r && l.file instanceof r)
                    )
                      return l.file.type &&
                        -1 !== l.file.type.search(/^image\//i)
                        ? a(e, l.file)
                        : l.file.type && -1 !== l.file.type.search(/^video\//i)
                          ? i(e, l.file)
                          : a(e, l.file).fail(function () {
                              return i(e, l.file);
                            });
                  }),
                ),
                      ...
                      return e.isImage
                        ? "image" !== n.__state
                          ? ((a = e.originalUrl),
                            ...
                            n.settings.previewUrlCallback &&
                              (a = n.settings.previewUrlCallback(a, e)),
                            ...
                            n.initImage([t.width, t.height], e.cdnUrlModifiers))
                          : void 0
                        : n.__setState("regular", { file: e });
                  }),
                ),
                this.file.fail(
                  t(function (e, t, a) {
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              return (
                ...
                "pending" !== e.state() ||
                !t.size ||
                t.size >= this.settings.multipartMinSize
                  ? i.reject().promise()
                  : (Ct(
                      t,
                      1550,
                      ...
                      .done(function (t, a) {
                        return we(t, "image/jpeg", 0.95, function (r) {
                          var o;
                          if (
                            (i.resolve(),
                            (t.width = t.height = 1),
                            "pending" === e.state() &&
                              "pending" === n.dialogApi.state() &&
                              n.file === e)
                          )
                            return (
                              (o = K.createObjectURL(r)),
                              n.dialogApi.always(function () {
                                return K.revokeObjectURL(o);
                              }),
                              "image" !== n.__state
                                ? (n.__setState("image", { src: o, name: "" }),
                                  n.initImage(a))
                                : void 0
                            );
                        });
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              return (
                (i = a.default.Deferred()),
                K && t.size
                  ? ((n = K.createObjectURL(t)),
                    vt(n)
                      .fail(function () {
                        return (K.revokeObjectURL(n), i.reject());
                      })
                      .done(function () {
                        if (
                          "pending" === e.state() &&
                          "pending" === r.dialogApi.state() &&
                          r.file === e
                        ) {
                          (r.dialogApi.always(function () {
                            return K.revokeObjectURL(n);
                          }),
                            i.resolve(),
                            r.__setState("video"));
                          var t = r.container.find(
                            ".uploadcare--preview__video",
                          );
                          return (
                            t.on("loadeddata", function () {
                              return (
                                (t.get(0).currentTime = 36e4),
                                t.off("loadeddata")
                              );
                            }),
                            t.on("ended", function () {
          ...
          },
          {
            ...
            value: function (e, t) {
              ((this.__state = e),
                ((t = t || {}).crop = this.settings.crop),
                this.container
                  .empty()
                  .append(
                    Da(
                      "tab-preview-".concat(e),
                      r(
                        r({}, t),
                        {},
                ...
                "error" === e &&
                  this.container.addClass(
                    "uploadcare--preview_status_error-" + t.errorType,
                  ),
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (
                ...
                (a = this.container.find(".uploadcare--preview__done")),
                (n = _t(i[0])
                  .done(function () {
                    return o.container.addClass(
                      "uploadcare--preview_status_loaded",
                    );
                  })
                  .fail(function () {
                    return (
                      (o.file = null),
                      o.__setState("error", { error: "loadImage" })
                    );
                  })),
                (r = function () {
                  return (
                    o.container
                      ...
                      .attr("tabindex", 0),
                    a.attr("disabled", !1).attr("aria-disabled", !1),
                    (o.widget = new $a(i, e, o.settings.crop[0])),
                    t && o.widget.setSelectionFromModifiers(t),
                    a.on("click", function () {
                      var e;
                      return (
                        (e = o.widget.applySelectionToFile(o.file)),
                        o.dialogApi.fileColl.replace(o.file, e),
                        !0
                      );
                    })
                  );
                ...
                return (
                  this.container
                    ...
                    .text(pa.t("dialog.tabs.preview.crop.title")),
                  this.container
                    .find(".uploadcare--preview__content")
                    .addClass("uploadcare--preview__content_crop"),
                  a.attr("disabled", !0).attr("aria-disabled", !0),
                  a.text(pa.t("dialog.tabs.preview.crop.done")),
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                a.default.each(this.settings.crop, function (r, o) {
                  var l, s, u, c, d, p;
                  return (
                    (d = o.preferedSize)
                      ? ((s = Y(d[0], d[1])),
                        (l = "".concat(d[0] / s, ":").concat(d[1] / s)))
                      : (l = pa.t("dialog.tabs.preview.crop.free")),
                    (c = i
                      .clone()
                      .appendTo(e)
                      .attr("data-caption", l)
                      .on("click", function (i) {
                        "true" !==
                          a.default(i.currentTarget).attr("aria-disabled") &&
                          !a.default(i.currentTarget).hasClass(t) &&
                          n.settings.crop.length > 1 &&
                          n.widget &&
                          (n.widget.setCrop(o),
                          e.find(">*").removeClass(t),
                          c.addClass(t));
                      })),
                    d
                      ? ((p = pe(d, [30, 30], !0)),
                        c
                          .children()
                          .css({
                            width: Math.max(20, p[0]),
                            height: Math.max(12, p[1]),
                          }))
                      : ((u = a
                          .default(
      ...
      t.prototype = {
        update: function () {
          ...
          (this.targets.each(function (a) {
            var i = e(this).offset();
            (i.top in t || (t[i.top] = []),
              t[i.top].push([i.left + this.offsetWidth / 2, this]));
          }),
            (this.rows = t));
        },
        find: function (e, t) {
          var a,
            ...
            o = this.rows;
          for (i in o) {
            (s = Math.abs(i - t)) < r && ((r = s), (a = o[i]));
          }
          ((r = Math.abs(a[0][0] - e)), (n = a[0][1]));
          for (var l = 1; l < a.length; l++) {
            var s;
            (s = Math.abs(a[l][0] - e)) < r && ((r = s), (n = a[l][1]));
          }
          return n;
        },
        findNotLast: function (e, t) {
          var a = this.find(e, t);
          return this.last && a && this.last == a ? null : (this.last = a);
        },
      };
      var a = "uploadcareMovable",
        i = {
          uploadcareMovable: function (t) {
            function i(e) {
              if (t.touch) {
                var a, i;
                if ((i = e.originalEvent.touches) && i.length) a = i[0];
                else {
                  if (!(i = e.originalEvent.changedTouches) || !i.length)
                    return;
                  a = i[0];
                }
                ((e.pageX = a.pageX), (e.pageY = a.pageY), (e.which = 1));
              }
            }
            t = e.extend(
              {
            ...
            var n = "mousedown.{} touchstart.{}".replace(/\{}/g, a);
            this.on(n, t.items, null, function (n) {
              if ((i(n), t.anyButton || 1 == n.which)) {
                n.preventDefault();
                var r = !1,
                  o = e(this),
                  l = !1,
                  s = o.position();
                ((s.top += o.offsetParent().scrollTop()),
                  (s.left += o.offsetParent().scrollLeft()));
                var u = "mousemove.{} touchmove.{}".replace(/\{}/g, a);
                e(document).on(u, function (e) {
                  if (
                    (i(e),
                    !r &&
                      (Math.abs(e.pageX - n.pageX) > t.distance ||
                        Math.abs(e.pageY - n.pageY) > t.distance) &&
                      ((r = !0),
                      (l = o
                        .clone()
                        .css({
                        ...
                        .appendTo(o.offsetParent())),
                      t.start({ event: e, dragged: o, fake: l })),
                    r)
                  ) {
                    e.preventDefault();
                    var a = "y" == t.axis ? 0 : e.pageX - n.pageX,
                      u = "x" == t.axis ? 0 : e.pageY - n.pageY;
                    (l.css({ left: a + s.left, top: u + s.top }),
                      t.move({ event: e, dragged: o, fake: l, dx: a, dy: u }));
                  }
                });
                u = "mouseup.{} touchend.{} touchcancel.{} touchleave.{}";
                e(document).on(u.replace(/\{}/g, a), function (s) {
                  i(s);
                  if (
                    (e(document).off(
                      "mousemove.{} touchmove.{} mouseup.{} touchend.{} touchcancel.{} touchleave.{}".replace(
                        /\{}/g,
                        a,
                      ),
                    ),
                    ...
                    s.preventDefault();
                    var u = s.pageX - n.pageX,
                      c = s.pageY - n.pageY;
                    ((r = !1),
                      t.finish({ event: s, dragged: o, fake: l, dx: u, dy: c }),
                      t.keepFake || l.remove());
                  }
                });
              }
          ...
          uploadcareSortable: function (i) {
            ...
            return (
              (r.start = function (e) {
                (i.start(e),
                  (n = new t(l.find(r.items).not(e.fake))),
                  (o = e.dragged.next()));
              }),
              (r.move = function (t) {
                if (((t.nearest = null), i.checkBounds(t))) {
                  var a = t.fake.offset(),
                    r = n.findNotLast(a.left + t.dragged.width() / 2, a.top);
                  ((t.nearest = e(r)),
                    r &&
                      r != t.dragged[0] &&
                      (t.dragged.nextAll().filter(r).length > 0
                        ? t.dragged.insertAfter(r)
                        : t.dragged.insertBefore(r),
                      i.attach(t),
                      (n.last = null),
                      n.update()));
                } else
                  null !== n.last &&
                    ((n.last = null),
                    o.length
                      ? t.dragged.insertBefore(o)
                      : t.dragged.parent().append(t.dragged),
                    i.attach(t),
                    n.update());
                i.move(t);
              }),
              (r.finish = function (t) {
                ...
                ((t.nearest = null),
                  i.checkBounds(t) &&
                    (t.nearest = e(
                      n.find(a.left + t.dragged.width() / 2, a.top),
                    )),
                  i.finish(t),
                  (n = null));
              }),
  ...
  var ai = (function (e) {
    ...
    function i() {
      ...
      return (
        s(this, i),
        (e = t.apply(this, arguments)).container.append(
          Da("tab-preview-multiple"),
        ),
        (e.__fileTpl = a.default(Da("tab-preview-multiple-file"))),
        (e.fileListEl = e.container.find(".uploadcare--files")),
        (e.doneBtnEl = e.container.find(".uploadcare--preview__done")),
        a.default.each(e.dialogApi.fileColl.get(), function (t, a) {
          return e.__fileAdded(a);
        }),
        e.__updateContainerView(),
        e.dialogApi.fileColl.onAdd.add(e.__fileAdded.bind(m(e)), function () {
          return e.__updateContainerView();
        }),
        e.dialogApi.fileColl.onRemove.add(
          e.__fileRemoved.bind(m(e)),
          function () {
            return e.__updateContainerView();
          },
        ),
        e.dialogApi.fileColl.onReplace.add(
          e.__fileReplaced.bind(m(e)),
          function () {
            return e.__updateContainerView();
          },
        ),
        e.dialogApi.fileColl.onAnyProgress(e.__fileProgress.bind(m(e))),
        e.dialogApi.fileColl.onAnyDone(e.__fileDone.bind(m(e))),
        e.dialogApi.fileColl.onAnyFail(e.__fileFailed.bind(m(e))),
        e.fileListEl.addClass(
          e.settings.imagesOnly
      ...
      c(i, [
            ...
            return this.fileListEl.uploadcareSortable({
              ...
              finish: function (t) {
                ...
                return (
                  ...
                  (a = e.container.find(".uploadcare--file")),
                  (i = function (t) {
                    return a.index(e.__fileToEl(t));
                  }),
        ...
        },
        {
          ...
          value: function () {
            ...
            if (
              ((r =
                (t = this.dialogApi.fileColl.length()) >
                this.settings.multipleMax),
              (n = t < this.settings.multipleMin),
              (a = r || n),
              this.doneBtnEl.attr("disabled", a).attr("aria-disabled", a),
              (i = pa
                .t("dialog.tabs.preview.multiple.question")
                .replace("%files%", pa.t("file", t))),
              this.container.find(".uploadcare--preview__title").text(i),
              (e = this.container.find(
        ...
        },
        {
          ...
          value: function (e, t) {
            var a;
            return (
              (a = t.name || pa.t("dialog.tabs.preview.unknownName")),
              e.find(".uploadcare--file__name").text(a),
              e
              ...
              e.find(".uploadcare--file__size").text(ve(t.size, "–"))
            );
          },
        },
        {
          ...
          value: function (e, t) {
            ...
            return (
              (a = this.__fileToEl(e))
                ...
                .css("width", Math.round(100 * t.progress) + "%"),
              this.__updateFileInfo(a, t.incompleteFileInfo)
            );
          },
        },
        {
          ...
          value: function (e, t) {
            ...
            return (
              ...
              t.isImage
                ? ((i = "".concat(
                    t.cdnUrl,
                    "-/quality/lightest/-/preview/108x108/",
                  )),
                  this.settings.previewUrlCallback &&
                    (i = this.settings.previewUrlCallback(i, t)),
                  (o = n.find(".uploadcare--file__name").text()),
                  (r = a
                    .default("<img>")
                    .attr("src", i)
                    .attr("alt", o)
              ...
              n.find(".uploadcare--file__preview").html(r),
              n.find(".uploadcare--file__description").on("click", function () {
                return ui(e, l.settings).done(function (t) {
                  return l.dialogApi.fileColl.replace(e, t);
                });
              })
            );
          },
        },
        {
          ...
          value: function (e, t, i, n) {
            var r =
                ...
                pa.t("serverErrors.".concat(null == n ? void 0 : n.code)) ||
                (null == n ? void 0 : n.message) ||
                pa.t("errors.".concat(t)),
              o = this.__fileToEl(e)
                .removeClass("uploadcare--file_status_uploading")
                .addClass("uploadcare--file_status_error");
            o.find(".uploadcare--file__error").text(r);
            var l = a
              .default(
              ...
              .attr("role", "presentation")
              .attr("class", "uploadcare--icon uploadcare--file__icon");
            return o.find(".uploadcare--file__preview").html(l);
          },
        },
        {
          key: "__fileAdded",
        ...
        },
        {
          key: "__fileRemoved",
          value: function (e) {
            return (this.__fileToEl(e).remove(), a.default(e).removeData());
          },
        },
        {
          key: "__fileReplaced",
          value: function (e, t) {
            return (
              this.__createFileEl(t).insertAfter(this.__fileToEl(e)),
              this.__fileRemoved(e)
            );
          },
        },
        {
          key: "__fileToEl",
          value: function (e) {
            return a.default(e).data("dpm-el") || a.default();
          },
        },
        {
          key: "__createFileEl",
          value: function (e) {
            ...
            return (
              (t = this.__fileTpl
                .clone()
                .on("click", ".uploadcare--file__remove", function () {
                  return i.dialogApi.fileColl.remove(e);
                })),
              a.default(e).data("dpm-el", t),
              t
            );
          },
        },
  ...
  T() &&
    a.default(window).on("keydown", function (e) {
      if (
        oi() &&
        (27 === e.which &&
          (e.stopImmediatePropagation(), null != ii && ii.reject()),
        9 === e.which)
      )
        return (function (e) {
          return !e.shiftKey && ri.last().is(e.target)
            ? (e.preventDefault(), ri.first().focus())
            : e.shiftKey && ri.first().is(e.target)
              ? (e.preventDefault(), ri.last().focus())
              : void 0;
        })(e);
    });
  var ii = null,
    ...
    si = function (e, t, i) {
      ...
      return (
        ...
        (r = a.default(Da("dialog")).appendTo("body")),
        (o = ci(r.find(".uploadcare--dialog__placeholder"), e, t, i, {
          inModal: !0,
        })),
        r.find(".uploadcare--panel").addClass("uploadcare--dialog__panel"),
        r.addClass("uploadcare--dialog_status_active"),
        (o.dialogElement = r),
        (ri = r.find("select, input, textarea, button, a[href]"))
          .first()
          .focus(),
        (n = (function (e, t) {
          var a, i;
          return (
            ...
            function () {
              return e.scrollTop(i).scrollLeft(a);
            }
          );
        })(a.default(window), "absolute" === r.css("position"))),
        a.default("html, body").addClass("uploadcare--page"),
        r.find(".uploadcare--dialog__close").on("click", o.reject),
        r.on("dblclick", function (e) {
          var t;
          if (
            a.default.contains(document.documentElement, e.target) &&
            ((t =
              ".uploadcare--dialog__panel, .uploadcare--dialog__powered-by"),
            !a.default(e.target).is(t) &&
              !a.default(e.target).parents(t).length)
          )
            return o.reject();
        }),
        (ii = o.always(function () {
          return (
            a.default("html, body").removeClass("uploadcare--page"),
            (ii = null),
            r.remove(),
            n(),
            ni.focus()
    ...
    ui = function (e, t) {
      ...
      return (
        (n = ii),
        (ii = null),
        (t = a.default.extend({}, t, { multiple: !1, tabs: "" })),
        (i = si(e, "preview", t)),
        null != n &&
          n.dialogElement.addClass("uploadcare--dialog_status_inactive"),
        i.always(function () {
          if (((ii = n), null != n))
            return (
              a.default("html, body").addClass("uploadcare--page"),
              n.dialogElement.removeClass("uploadcare--dialog_status_inactive")
            );
        }),
        i.onTabVisibility(function (e, t) {
          if ("preview" === e && !t) return i.reject();
        }),
        i
      );
    },
      ...
      var r,
        ...
        l =
          arguments.length > 4 && void 0 !== arguments[4]
            ...
            : { inModal: !1 };
      return (
        a.default.isPlainObject(i) && ((n = i), (i = null)),
        t
          ? ia(t)
            ? (t = t.files())
            : a.default.isArray(t) || (t = [t])
          : (t = []),
        (n = ft(n)),
        (o = new fi(n, e, t, i, l).publicPromise()),
        Q(
          o,
          (r = function (e) {
            return n.multiple ? va(e, n) : e[0];
          }),
          r,
        ).promise(o)
      );
  ...
  (pi("file", Xa),
    ...
    pi("huddle", za),
    pi("nft", za),
    pi("empty-pubkey", function (e, t, a, i) {
      return e.append(
        '<div class="uploadcare--tab__content">\n<div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title">Hello!</div>\n<div class="uploadcare--text">Your <a class="uploadcare--link" href="https://uploadcare.com/dashboard/">public key</a> is not set.</div>\n<div class="uploadcare--text">Add this to the &lt;head&gt; tag to start uploading files:</div>\n<div class="uploadcare--text uploadcare--text_pre">&lt;script&gt;\nUPLOADCARE_PUBLIC_KEY = \'your_public_key\';\n&lt;/script&gt;</div>\n</div>',
      );
    }),
    pi("preview", function (e, t, a, i, n) {
      if (i.previewStep || 0 !== a.fileColl.length())
        return new (i.multiple ? ai : ti)(e, t, a, i, n);
    }));
  var fi = (function () {
      function e(t, i, n, r, o) {
        var l,
        ...
        (s(this, e),
          ...
          (this.settings = t),
          (this.dfd = a.default.Deferred()),
          this.dfd.always(this.__closePanel),
          (l = ".uploadcare--panel"),
          (this.content = a.default(Da("dialog__panel"))),
          (this.panel = this.content.find(l).add(this.content.filter(l))),
          (this.placeholder = a.default(i)),
          this.placeholder.replaceWith(this.content),
          this.panel.append(a.default(Da("icons"))),
          ...
          this.files.onRemove.add(function () {
            if (0 === u.files.length()) return u.hideTab("preview");
          }),
          this.__autoCrop(this.files),
          (this.tabs = {}),
          this.__prepareFooter(),
          (this.onTabVisibility = a.default.Callbacks().add(function (e, t) {
            return u.panel
              .find(".uploadcare--menu__item_tab_".concat(e))
              .toggleClass("uploadcare--menu__item_hidden", !t);
          })),
        ...
        c(e, [
          ...
          },
          {
            ...
            value: function (e, t) {
              var a, i, n;
              for (
                t && (e = ea(e, t, this.settings)),
                  this.settings.multiple || (this.files.clear(), (e = [e[0]])),
                  i = 0,
                  n = e.length;
                i < n;
                i++
                ...
                ((a = e[i]),
                  this.settings.multipleMaxStrict &&
                  this.files.length() >= this.settings.multipleMax
                    ? a.cancel()
                    : this.files.add(a));
              return this.settings.previewStep
                ? (this.showTab("preview"),
                  this.settings.multiple ? void 0 : this.switchTab("preview"))
                : this.__resolve();
            },
          },
          {
            ...
            value: function (e) {
              ...
              if (this.settings.crop && this.settings.multiple) {
                for (t = 0, a = (i = this.settings.crop).length; t < a; t++)
                  if (!i[t].preferedSize) return;
                return e.autoThen(function (e) {
                  ...
                  return !e.isImage || e.cdnUrlModifiers || e.crop
                    ...
                    : ((t = e.originalImageInfo),
                      (a = pe(
                        n.settings.crop[0].preferedSize,
                        [t.width, t.height],
                        !0,
                      )),
                      fe(e, n.settings.crop[0], [t.width, t.height], {
                        width: a[0],
                        height: a[1],
                        left: Math.round((t.width - a[0]) / 2),
                        top: Math.round((t.height - a[1]) / 2),
                      }));
                });
              }
            },
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                (this.files.length()
                  ? (this.showTab("preview"), this.switchTab("preview"))
                  : (this.hideTab("preview"),
                    this.switchTab(e || this.__firstVisibleTab())),
                0 === this.settings.tabs.length)
              )
                return (
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                this.footer.on(
                  "click",
                  ".uploadcare--panel__done:not(:disabled)",
                  this.__resolve,
                ),
                this.__updateFooter(),
                ...
                (e = a
                  ...
                  : i && t
                    ? pa
                        .t("dialog.tabs.preview.multiple.tooFewFiles")
                        .replace("%min%", this.settings.multipleMin)
                    : pa.t("dialog.tabs.preview.multiple.title")),
                this.footer
                  .find(".uploadcare--panel__message")
                  .toggleClass("uploadcare--panel__message_hidden", 0 === i)
                  .toggleClass("uploadcare--error", a || t)
                  .text(e.replace("%files%", pa.t("file", i))),
                this.footer
          ...
          },
          {
            ...
            value: function (e) {
              var t,
                ...
                o = this;
              if (!(e in this.tabs)) {
                if (!(t = di[e])) throw new Error("No such tab: ".concat(e));
                return (
                  (r = a
                    .default("<div>")
                    .addClass("uploadcare--tab")
                    .addClass("uploadcare--tab_name_".concat(e))
                  ...
                  (i = a
                    .default("<div>", { role: "button", tabindex: "0" })
              ...
              if (e && this.currentTab !== e)
                return (
                  ...
                  this.panel
                    ...
                    .filter(".uploadcare--menu__item_tab_".concat(e))
                    .addClass("uploadcare--menu__item_current"),
                  (t = "uploadcare--tab"),
                  this.panel
                    .find(".".concat(t))
                    .removeClass("".concat(t, "_current"))
                    .filter(".".concat(t, "_name_").concat(e))
                    .addClass("".concat(t, "_current")),
          ...
          },
          {
            key: "hideTab",
            value: function (e) {
              if ((this.onTabVisibility.fire(e, !1), this.currentTab === e))
          ...
          },
          {
            ...
            value: function () {
              var e, t, a, i;
              for (e = 0, t = (a = this.settings.tabs).length; e < t; e++)
                if (((i = a[e]), this.isTabVisible(i))) return i;
            },
          },
          {
            key: "__welcome",
            value: function () {
              ...
              for (
                this.addTab("empty-pubkey"),
                  ...
                  e = 0,
                  t = (a = this.settings.tabs).length;
                e < t;
                e++
              )
                ((i = a[e]), this.__addFakeTab(i));
              return null;
            },
          },
          {
    ...
    hi = (function () {
      function e(t, i) {
        ...
        (s(this, e),
          ...
          (this.__onDialogOpen = a.default.Callbacks()),
          (this.__onUploadComplete = a.default.Callbacks()),
          (this.__onChange = a.default.Callbacks().add(function (e) {
            return null != e
          ...
          (this.__hasValue = !1),
          X(function () {
            if (!n.__hasValue) return n.reloadInfo();
          }));
      }
      return (
        c(e, [
          {
            ...
            value: function () {
              var e,
                t = this;
              return (
                (this.template = new Ga(this.settings, this.element)),
                (e = ["buttons.choose"]).push(
                  this.settings.imagesOnly ? "images" : "files",
                ),
                e.push(this.settings.multiple ? "other" : "one"),
                this.template
                  .addButton("open", pa.t(e.join(".")))
                  .toggleClass("needsclick", this.settings.systemDialog)
                  .on("click", function () {
                    return t.openDialog();
                  }),
                this.template
                  .addButton("cancel", pa.t("buttons.cancel"))
                  .on("click", function () {
                    return t.__setObject(null);
                  }),
                this.template
                  .addButton("remove", pa.t("buttons.remove"))
                  .on("click", function () {
                    return t.__setObject(null);
                  }),
                this.template.content.on(
                  "click",
                ...
                Na(
                  ...
                  this.__handleDirectSelection.bind(this),
                ),
                this.template.reset()
              );
            },
          },
          {
            key: "__infoToValue",
            value: function (e) {
              return e.cdnUrlModifiers || this.settings.pathValue
                ? e.cdnUrl
                : e.uuid;
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                (this.currentObject = null),
                null != e && "function" == typeof e.cancel && e.cancel(),
                this.template.reset()
              );
            },
          },
          {
            key: "__setObject",
            value: function (e) {
              if (e !== this.currentObject)
                return (
                  this.__reset(),
                  e
                    ? ((this.currentObject = e), this.__watchCurrentObject())
                    : this.element.val(""),
            ...
            value: function () {
              ...
              if ((e = this.__currentFile()))
                return (
                  ...
                  e
                    .done(function (a) {
                      if (e === t.__currentFile())
                        return t.__onUploadingDone(a);
                    })
                    .fail(function (a, i, n) {
                      if (e === t.__currentFile())
                        return t.__onUploadingFailed(a, n);
                    })
                );
            },
          },
          {
            ...
            value: function (e) {
              return (
                this.element.val(this.__infoToValue(e)),
                this.template.setFileInfo(e),
          ...
          },
          {
            ...
            value: function (e) {
              return this.__setObject(aa(e, this.settings));
            },
          },
          {
            key: "value",
            value: function (e) {
              return void 0 !== e
                ? ((this.__hasValue = !0), this.__setExternalValue(e), this)
                : this.currentObject;
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return this.settings.systemDialog
                ? ge(this.template.content, this.settings, function (e) {
          ...
          },
          {
            ...
            value: function (e) {
              var t;
              return (
                (t = si(this.currentObject, e, this.settings)),
                this.__onDialogOpen.fire(t),
                t.done(this.__setObject.bind(this))
              );
            },
          },
          {
      ...
      return (
        c(a, [
          ...
          },
          {
            ...
            value: function (e, t) {
              var a = $t(e, t[0], this.settings);
              return this.settings.systemDialog || !this.settings.previewStep
                ? this.__setObject(a)
                : this.__openDialog("preview").addFiles([a]);
            },
          },
        ]),
        a
    ...
    return (
      c(a, [
        ...
        },
        {
          key: "__setObject",
          value: function (e) {
            return ra(this.currentObject, e)
              ? e
                ? void 0
                : (this.__reset(), this.element.val(""))
              : b(f(a.prototype), "__setObject", this).call(this, e);
          },
        },
        {
          key: "__setExternalValue",
          value: function (e) {
            var t,
              a = this;
            return (
              (this.__lastGroupPr = t = na(e, this.settings)),
              e &&
                (this.template.setStatus("started"),
                this.template.statusText.text(pa.t("loadingInfo"))),
              t
                .done(function (e) {
                  if (a.__lastGroupPr === t) return a.__setObject(e);
                })
                .fail(function () {
                  if (a.__lastGroupPr === t)
                    return a.__onUploadingFailed("createGroup");
                })
            );
          },
        },
        {
          key: "__handleDirectSelection",
          value: function (e, t) {
            var a = ea(e, t, this.settings);
            return this.settings.systemDialog
              ? this.__setObject(va(a, this.settings))
              : this.__openDialog("preview").addFiles(a);
          },
        },
      ]),
  ...
  gi._name = "MultipleWidget";
  var _i = "uploadcareWidget",
    vi = '[role~="uploadcare-uploader"]',
    bi = function () {
      var e,
        t,
        i,
        ...
        l =
          arguments.length > 0 && void 0 !== arguments[0]
            ? arguments[0]
            : ":root";
      for (r = [], t = 0, i = (n = a.default(l)).length; t < i; t++)
        ((e = n[t]), (o = yi(e.querySelectorAll(vi))), (r = r.concat(o)));
      return r;
    },
    yi = function (e) {
      var t, i, n, r, o;
      for (n = [], t = 0, i = e.length; t < i; t++)
        ((r = e[t]),
          ((o = a.default(r).data(_i)) && o.inputElement === r) ||
            n.push(zi(r)));
      return n;
    },
    wi = function (e, t) {
    ...
    zi = function (e) {
      ...
      (n.length > 1 && C("There are multiple DOM elements matching selector"),
        (e = n.eq(0)));
      var o = ft(r(r({}, t), e.data())),
        l = o.multiple ? gi : mi;
      if (i && l !== i)
        throw new Error(
          "This element should be processed using ".concat(l._name),
        );
      var s = e.data(_i);
      if (!s || s.inputElement !== e[0]) {
        Ai(e);
        var u = new l(e, o);
        ((s = u.api()), e.data(_i, s), u.template.content.data(_i, s));
      }
      return s;
    },
    Ai = function (e) {
      return e.off(".uploadcare").each(function () {
        var e, t;
        if (
          (e = (t = a.default(this).next(".uploadcare--widget")).data(_i)) &&
          e.inputElement === this
        )
          return t.remove();
      });
    ...
    Ci = J(function (e, t) {
      if (((e = pt(e, t)), !t)) return (e.live && setInterval(bi, 100), bi());
    });
  T() &&
    a.default(function () {
  ...
  var Si = r(
    ...
    Ti = r(
      ...
      {},
      {
        ...
        Widget: ki,
        tabsCss: ka,
        dragdrop: { receiveDrop: Na, support: La, uploadDrop: qa },
      },
    ),
    ji = Ca(Si);
  return r(
    r({}, Ti),
    {},
    { plugin: ji, locales: Object.keys(pa.translations) },
  );
});
