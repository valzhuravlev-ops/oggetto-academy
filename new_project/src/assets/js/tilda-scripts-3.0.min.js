  ...
  t_onReady(function () {
    setTimeout(function () {
      ...
      if (
        ...
        for (
          var o = document.body.childNodes, i = [], r = 0;
          r < o.length;
          r++
        ) {
          var a = o[r];
        ...
        for (var r = 0; r < i.length; r++)
          -1 !== i[r].nodeValue.indexOf("'t remove this l") &&
            document
    ...
    function o(t) {
      for (
        var e = document.querySelectorAll(
            '.oggy-text:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-name:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .oggy-title:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .oggy-descr:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-heading:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .oggy-text-impact:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .oggy-subtitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .oggy-uptitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"])',
          ),
          n = 0;
        n < e.length;
        n++
    ...
    (document.body.addEventListener(
      ...
      document.body.addEventListener("popupHidden", function () {
        ...
        t &&
          (t.cancelTimeout &&
            (window.clearTimeout(t.cancelTimeout), (t.cancelTimeout = null)),
          (t.cancelTimeout = window.setTimeout(
            function () {
