...
var FORMS_API_FIELD = {
  ...
  t_formsApi__safeSetValue = function t(e, r, o) {
    var n,
      ...
      i = void 0 !== a && a;
    return (
      e && e.value !== r && ((e.value = r), i || t_formsApi__sendChange(e)),
      r
    );
  },
    ...
    return (
      (e.onFieldReady = function () {
        return t_formsApi__waitForFieldReadyState(e).then(function () {
          ...
          return (
            (e.data.ownVariantInput = t),
            (e.data.ownVariantTitle = r),
            e
          );
        });
      }),
...
var t_forms__updateAllVariables = function t(e) {
  ...
  t_forms__focusInput = function t(e) {
    try {
      ...
      var o = _catch(
        function () {
          return Promise.resolve(t_formsApi__initTildaField(r)).then(
            function (t) {
              t.focus();
            },
          );
...
function t_forms__combineFieldsWithDefWidth(t, e) {
  var r = [],
    o;
  (t_forms__createArrWithAllRows(t, "t-input-group_widthdef").forEach(
    function (t) {
      var e = 4;
      if (t.length > 4)
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
    ...
    m ||
      (document.body.insertAdjacentHTML(
        "beforeend",
        '<div id="tilda-popup-for-error" class="js-form-popup-errorbox tn-form__errorbox-popup" style="display: none;"> <div class="t-form__errorbox-text oggy-text oggy-text_xs"> error </div> <div class="tn-form__errorbox-close js-errorbox-close"> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-left"></div> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-right"></div> </div> </div>',
      ),
      t_addEventListener(
        (m = document.getElementById("tilda-popup-for-error")),
        "click",
                    ...
                    if (
                      ...
                      (localStorage.setItem(
                        ...
                        t_onFuncLoad("t_bd__init", function () {
                          (t_bd__init(),
                            window.tcart__initAuthAndDelivery(!0, !1));
                        }));
                    }
                    try {
...
function t_forms__showFormErrors(t, e, r) {
  e.type.forEach(function (o) {
    var n = t.querySelectorAll(".js-rule-error-" + o),
      ...
      s;
    (n.length ? n : t.querySelectorAll(".js-rule-error-all")).forEach(
      function (t) {
      ...
      if (i.length)
        new Set(
          ...
          if (r) {
            ...
            (o = t_forms__includeCheckboxesForInputList(o)).forEach(
              function (t) {
